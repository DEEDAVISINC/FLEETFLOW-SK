              ...
              >
                ...
                {shipment.weather && (
                  <div style={{
                    ...
                    padding: '8px',
                    borderRadius: '8px',
                    background: selectedShipment === shipment.id ? 'rgba(255, 255, 255, 0.1)' : 'rgba(248, 250, 252, 0.9)',
                    border: '1px solid rgba(0, 0, 0, 0.1)',
                    fontSize: '12px'
                  }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                      ...
                      <span style={{ 
                        color: selectedShipment === shipment.id ? 'white' : '#374151',
                        fontWeight: '600'
                      }}>
                        {shipment.weather.temperature}°F - {shipment.weather.condition}
                      </span>
                    </div>
                    {shipment.weatherRisk && shipment.weatherRisk !== 'low' && (
                      <div style={{
                        padding: '4px 8px',
                        borderRadius: '6px',
                        background: shipment.weatherRisk === 'extreme' ? '#fef2f2' : 
                                   shipment.weatherRisk === 'high' ? '#fef3cd' : '#fefce8',
                        color: shipment.weatherRisk === 'extreme' ? '#dc2626' : 
                               shipment.weatherRisk === 'high' ? '#d97706' : '#ca8a04',
                        fontSize: '11px',
                        fontWeight: '600',
                        textAlign: 'center'
                      }}>
                        ⚠️ {shipment.weatherRisk.charAt(0).toUpperCase() + shipment.weatherRisk.slice(1)} Weather Risk
                      </div>
                    )}
                    {shipment.weather.alerts && shipment.weather.alerts.length > 0 && (
                      <div style={{
                        marginTop: '4px',
                        padding: '4px 8px',
                        borderRadius: '6px',
                        ...
                        🚨 {shipment.weather.alerts.length} Weather Alert{shipment.weather.alerts.length > 1 ? 's' : ''}
                      </div>
                    )}
                  </div>
                )}
              ...
              <div style={{
                ...
                🌤️ Loading weather data...
                    ...
                    <div style={{ 
                      ...
                      {getWeatherIcon(shipment.weather.condition)} {shipment.weather.temperature}°F
                    </div>
                    <div style={{ 
                      lineHeight: 1 
                    }}>
                      {shipment.weather.description}
                    </div>
                    <div style={{
                      marginLeft: 'auto',
                      padding: '4px 8px',
                      borderRadius: '4px',
                      background: getWeatherRiskColor(shipment.weatherRisk),
                      color: selectedShipment === shipment.id ? 'white' : '#1f2937',
                      fontWeight: '500',
                      fontSize: '12px'
                    }}>
                      {shipment.weatherRisk?.charAt(0).toUpperCase() + shipment.weatherRisk?.slice(1)} Risk
                    </div>
                  </div>
                )}
              </div>
