...
export default function UniversityPage() {
  const [activeTab, setActiveTab] = useState<'hub' | 'courses' | 'certifications' | 'ai-training' | 'occupational-training'>('hub');
  const [selectedCategory, setSelectedCategory] = useState<string>('all');
  const [searchTerm, setSearchTerm] = useState('');
  const [activeAIModule, setActiveAIModule] = useState<string>('ai-fundamentals');
  const [activeOccupationalModule, setActiveOccupationalModule] = useState<string>('');
  ...
  const [occupationalProgress, setOccupationalProgress] = useState<{[key: string]: boolean}>({
  ...
  React.useEffect(() => {
    ...
    if (tab && ['hub', 'courses', 'ai-training', 'certifications', 'occupational-training'].includes(tab)) {
  ...
  const occupationalTrainingModules = [
    {
      ...
      description: 'Master the comprehensive carrier onboarding workflow including FMCSA verification, documentation, and portal setup.',
      duration: '60 min',
    ...
    },
    {
      ...
      description: 'Complete training on dispatch operations, load management, and carrier coordination.',
      duration: '50 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Advanced broker operations including load posting, carrier sourcing, and rate negotiations.',
      duration: '55 min',
      difficulty: 'Advanced',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'Fleet maintenance scheduling, work order management, and compliance tracking.',
      duration: '45 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Complete accounting system training including invoicing, payments, and financial reporting.',
      duration: '70 min',
      difficulty: 'Advanced',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'DOT compliance, safety protocols, and regulatory requirements management.',
      duration: '65 min',
      difficulty: 'Advanced',
      category: 'Compliance',
      certification: true,
    ...
    },
    {
      ...
      description: 'Real-time tracking, route monitoring, and delivery management system.',
      duration: '40 min',
      difficulty: 'Beginner',
      category: 'Technology',
      certification: true,
    ...
    },
    {
      ...
      description: 'Training management, course creation, and certification tracking.',
      duration: '35 min',
      difficulty: 'Beginner',
      category: 'Technology',
      certification: true,
    ...
    },
    {
      ...
      description: 'Request for proposal system, bid management, and vendor selection.',
      duration: '55 min',
      difficulty: 'Intermediate',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'Advanced AI-powered dispatch automation and optimization systems.',
      duration: '60 min',
      difficulty: 'Advanced',
      category: 'Technology',
      certification: true,
    ...
    },
    {
      ...
      description: 'Master document upload, categorization, approval workflows, and compliance tracking.',
      duration: '40 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
  ...
  const courses: Course[] = [
    {
      ...
      description: 'Master the automated 24-hour carrier onboarding process with document verification.',
      duration: '45 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Complete workflow management system integration and optimization.',
      duration: '60 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Professional customer service standards and communication protocols.',
      duration: '40 min',
      difficulty: 'Beginner',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'Essential knowledge for freight broker agents including regulations and best practices.',
      duration: '90 min',
      difficulty: 'Beginner',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'Current FMCSA regulations, safety requirements, and compliance standards.',
      duration: '55 min',
      difficulty: 'Advanced',
      category: 'Compliance',
      certification: true,
    ...
    },
    {
      ...
      description: 'Advanced load matching, route optimization, and carrier performance management.',
      duration: '50 min',
      difficulty: 'Advanced',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Department of Transportation regulations and compliance requirements.',
      duration: '65 min',
      difficulty: 'Intermediate',
      category: 'Compliance',
      certification: true,
    ...
    },
    {
      ...
      description: 'Electronic Logging Devices, integration requirements, and compliance monitoring.',
      duration: '30 min',
      difficulty: 'Beginner',
      category: 'Technology',
      certification: false,
    ...
    },
    {
      ...
      description: 'Comprehensive safety programs for transportation operations.',
      duration: '45 min',
      difficulty: 'Intermediate',
      category: 'Safety',
      certification: true,
    ...
    },
    {
      ...
      description: 'Advanced route planning, fuel efficiency, and delivery optimization.',
      duration: '40 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Effective load matching techniques and carrier selection criteria.',
      duration: '35 min',
      difficulty: 'Beginner',
      category: 'Operations',
      certification: false,
    ...
    },
    {
      ...
      description: 'Financial management, invoicing, and payment processing systems.',
      duration: '50 min',
      difficulty: 'Intermediate',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'Introduction to artificial intelligence in transportation management and fleet operations.',
      duration: '45 min',
      difficulty: 'Beginner',
      category: 'Technology',
      certification: true,
    ...
    },
    {
      ...
      description: 'Complete guide to using FleetFlow\'s AI workflow system for dispatchers, brokers, and administrators.',
      duration: '60 min',
      difficulty: 'Intermediate',
      category: 'Technology',
      certification: true,
    ...
    },
    {
      ...
      description: 'Master AI-powered load matching, route optimization, and capacity forecasting for dispatchers.',
      duration: '55 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'AI-powered lead scoring, pricing optimization, and customer relationship management for brokers.',
      duration: '50 min',
      difficulty: 'Intermediate',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'Predictive maintenance, compliance monitoring, and performance analytics for system administrators.',
      duration: '65 min',
      difficulty: 'Advanced',
      category: 'Technology',
      certification: true,
    ...
    },
    {
      ...
      description: 'Understanding AI metrics, interpreting performance data, and optimizing system effectiveness.',
      duration: '40 min',
      difficulty: 'Intermediate',
      category: 'Technology',
      certification: true,
    ...
    },
    {
      ...
      description: 'Configure and customize AI workflows, set preferences, and optimize system performance.',
      duration: '50 min',
      difficulty: 'Advanced',
      category: 'Technology',
      certification: true,
    ...
    },
    {
      ...
      description: 'Identify and resolve common AI system issues, optimize performance, and maintain system health.',
      duration: '35 min',
      difficulty: 'Advanced',
      category: 'Technology',
      certification: false,
    ...
    // New Dispatcher Training Resources
    {
      ...
      description: 'Master shift management, driver scheduling, and workload distribution using FleetFlow\'s existing tools.',
      duration: '45 min',
      difficulty: 'Beginner',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'FREE: Learn to optimize fleet utilization and forecast capacity needs using FleetFlow\'s analytics.',
      duration: '35 min',
      difficulty: 'Beginner',
      category: 'Operations',
      certification: false,
    ...
    },
    {
      ...
      description: 'Maximize FleetFlow\'s automated workflows for load assignment, tracking, and communication.',
      duration: '50 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Advanced techniques for efficient load-to-driver matching using FleetFlow\'s assignment system.',
      duration: '40 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Comprehensive guide to using all FleetFlow dispatch features for maximum efficiency.',
      duration: '55 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Professional communication protocols for dispatchers using FleetFlow\'s communication tools.',
      duration: '30 min',
      difficulty: 'Beginner',
      category: 'Operations',
      certification: false,
    ...
    },
    {
      ...
      description: 'Strategies to maximize fleet efficiency and reduce deadhead miles using FleetFlow analytics.',
      duration: '45 min',
      difficulty: 'Advanced',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Crisis management and emergency response procedures for dispatchers.',
      duration: '40 min',
      difficulty: 'Intermediate',
      category: 'Safety',
      certification: true,
    ...
    },
    {
      ...
      description: 'Complete guide to FleetFlow\'s Dispatch Central dashboard and all its features.',
      duration: '60 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Master the live load tracking system integration with dispatch operations.',
      duration: '35 min',
      difficulty: 'Beginner',
      category: 'Technology',
      certification: false,
    ...
    },
    {
      ...
      description: 'Understanding and acting on dispatcher performance metrics and KPIs.',
      duration: '40 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'FREE: Quick tips and tricks to improve daily dispatcher productivity and efficiency.',
      duration: '25 min',
      difficulty: 'Beginner',
      category: 'Operations',
      certification: false,
    ...
    // Driver Management Training Modules
    {
      ...
      description: 'Comprehensive strategies and best practices for retaining quality drivers and reducing turnover.',
      duration: '50 min',
      difficulty: 'Intermediate',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'Essential skills for tracking, measuring, and improving driver performance through data-driven approaches.',
      duration: '45 min',
      difficulty: 'Intermediate',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Master professional communication protocols between dispatchers, drivers, and fleet management.',
      duration: '40 min',
      difficulty: 'Beginner',
      category: 'Operations',
      certification: true,
    ...
    },
    {
      ...
      description: 'Design and implement effective driver incentive programs and bonus management systems.',
      duration: '55 min',
      difficulty: 'Advanced',
      category: 'Business',
      certification: true,
    ...
    },
    {
      ...
      description: 'FREE: Building positive relationships with drivers to improve retention and job satisfaction.',
      duration: '30 min',
      difficulty: 'Beginner',
      category: 'Business',
      certification: false,
    ...
    },
    {
      ...
      description: 'Human resources management specifically tailored for transportation and fleet operations.',
      duration: '60 min',
      difficulty: 'Advanced',
      category: 'Business',
      certification: true,
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '32px' }}>
          {[
            ...
            { id: 'occupational-training', label: 'Occupational Training', icon: '👔' }
          ].map((tab) => (
            <button
              key={tab.id}
              ...
              style={{
                ...
                color: activeTab === tab.id
                  ...
                  : 'white',
                backdropFilter: 'blur(10px)',
                border: activeTab === tab.id ? '1px solid rgba(255, 255, 255, 0.4)' : '1px solid rgba(255, 255, 255, 0.2)',
                transform: activeTab === tab.id ? 'translateY(-2px)' : 'translateY(0)',
                boxShadow: activeTab === tab.id ? '0 8px 25px rgba(0, 0, 0, 0.2)' : 'none'
              }}
            >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#3b82f6', margin: '0 0 4px 0' }}>
                  {courses.length}
                </h3>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2rem', marginBottom: '8px' }}>🏆</div>
                <h3 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#10b981', margin: '0 0 4px 0' }}>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2rem', marginBottom: '8px' }}>👥</div>
                <h3 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#f59e0b', margin: '0 0 4px 0' }}>
                  {Math.round(courses.reduce((sum, course) => sum + course.enrolledCount, 0) / 1000)}K
                </h3>
                <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px', margin: 0 }}>
                  Students
                </p>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '2rem', marginBottom: '8px' }}>⭐</div>
                <h3 style={{ fontSize: '2rem', fontWeight: 'bold', color: '#a855f7', margin: '0 0 4px 0' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                onMouseOut={(e) => {
                  ...
                  <h3 style={{ color: '#3b82f6', fontSize: '20px', marginBottom: '12px', fontWeight: 'bold' }}>
                    Dispatcher Training
                  </h3>
                  <p style={{ color: 'rgba(255,255,255,0.8)', marginBottom: '20px', fontSize: '14px', lineHeight: '1.6' }}>
                    Load coordination, carrier management, and dispatch operations
                  </p>
                  <button
                    onClick={() => window.location.href = '/training?role=dispatcher'}
                    style={{
                ...
                onMouseOut={(e) => {
                  ...
                  <div style={{ fontSize: '3rem', marginBottom: '16px' }}>🏢</div>
                  <h3 style={{ color: '#10b981', fontSize: '20px', marginBottom: '12px', fontWeight: 'bold' }}>
                  ...
                  <button
                    onClick={() => window.location.href = '/training/broker-agent-resources'}
                    style={{
                      background: 'linear-gradient(135deg, #10b981, #059669)',
                      color: 'white',
                      padding: '12px 24px',
                ...
                onMouseOut={(e) => {
                  ...
                  <div style={{ fontSize: '3rem', marginBottom: '16px' }}>🚛</div>
                  <h3 style={{ color: '#f59e0b', fontSize: '20px', marginBottom: '12px', fontWeight: 'bold' }}>
                    Driver Training
                  </h3>
                  <p style={{ color: 'rgba(255,255,255,0.8)', marginBottom: '20px', fontSize: '14px', lineHeight: '1.6' }}>
                  ...
                  <button
                    onClick={() => window.location.href = '/training?role=driver'}
                    style={{
                ...
                onMouseOut={(e) => {
                  ...
                  <h3 style={{ color: '#8b5cf6', fontSize: '20px', marginBottom: '12px', fontWeight: 'bold' }}>
                    System Training
                  </h3>
                  <p style={{ color: 'rgba(255,255,255,0.8)', marginBottom: '20px', fontSize: '14px', lineHeight: '1.6' }}>
                  ...
                  <button
                    onClick={() => window.location.href = '/training?role=system'}
                    style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>
                    {Object.values(aiProgress).filter(Boolean).length}/{aiTrainingModules.length}
                  </div>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '2rem', marginBottom: '8px' }}>🏆</div>
                  <div style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>
                    {aiTrainingModules.filter(m => m.content && aiProgress[m.id]).length}
                  </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: '24px' }}>
              ...
              <div style={{
                ...
                {aiTrainingModules.map(module => (
                  <button
                    key={module.id}
                    onClick={() => !module.locked && setActiveAIModule(module.id)}
                    disabled={module.locked}
                    style={{
                      width: '100%',
                      background: activeAIModule === module.id 
              ...
              {/* Module Content */}
              {(() => {
                const activeModuleData = aiTrainingModules.find(m => m.id === activeAIModule);
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Master every aspect of FleetFlow with comprehensive page-specific training
              </p>
              <div style={{
                display: 'flex',
                justifyContent: 'center',
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '0.9rem', opacity: 0.8 }}>Training Modules</div>
                </div>
                <div style={{
                  background: 'rgba(255, 255, 255, 0.1)',
                  padding: '16px 24px',
                  ...
                  <div style={{ fontSize: '2rem', marginBottom: '8px' }}>❓</div>
                  <div style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>
                    {occupationalTrainingModules.reduce((sum, module) => sum + module.quizQuestions, 0)}
                  </div>
                  <div style={{ fontSize: '0.9rem', opacity: 0.8 }}>Quiz Questions</div>
                </div>
                <div style={{
                  background: 'rgba(255, 255, 255, 0.1)',
                  padding: '16px 24px',
                  ...
                  <div style={{ fontSize: '2rem', marginBottom: '8px' }}>🎯</div>
                  <div style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>
                    {occupationalTrainingModules.reduce((sum, module) => sum + module.practicalExercises, 0)}
                  </div>
                  <div style={{ fontSize: '0.9rem', opacity: 0.8 }}>Practical Exercises</div>
                </div>
                <div style={{
                  background: 'rgba(255, 255, 255, 0.1)',
                  padding: '16px 24px',
                  ...
                  <div style={{ fontSize: '2rem', marginBottom: '8px' }}>🏆</div>
                  <div style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>
                    {occupationalTrainingModules.filter(module => module.certification).length}
                  </div>
                  <div style={{ fontSize: '0.9rem', opacity: 0.8 }}>Certifications</div>
                </div>
              </div>
            ...
            <div style={{
              ...
              {occupationalTrainingModules.map((module, index) => {
                ...
                const difficultyColor = module.difficulty === 'Beginner' ? '#10b981' : 
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <div style={{ fontSize: '1rem', fontWeight: 'bold' }}>{module.duration}</div>
                      </div>
                      <div style={{
                        background: 'rgba(255, 255, 255, 0.1)',
                        padding: '8px 12px',
                        ...
                        <div style={{ fontSize: '0.8rem', opacity: 0.7 }}>Quiz Questions</div>
                        <div style={{ fontSize: '1rem', fontWeight: 'bold' }}>{module.quizQuestions}</div>
                      </div>
                      <div style={{
                        background: 'rgba(255, 255, 255, 0.1)',
                        padding: '8px 12px',
                        ...
                        <div style={{ fontSize: '0.8rem', opacity: 0.7 }}>Exercises</div>
                        <div style={{ fontSize: '1rem', fontWeight: 'bold' }}>{module.practicalExercises}</div>
                      </div>
                    </div>
                    ...
                    <div style={{
                      ...
                      <button
                        style={{
                          background: isCompleted ? 'rgba(16, 185, 129, 0.8)' : 'linear-gradient(135deg, #667eea, #764ba2)',
                          color: 'white',
                          padding: '12px 20px',
                          borderRadius: '8px',
                          border: 'none',
                        ...
                        onClick={(e) => {
                          ...
                          if (!isCompleted) {
                            ...
                            alert(`🎉 Congratulations! You've completed the ${module.title} training module and earned your certification!`);
                          }
                        }}
                      >
            ...
            {activeOccupationalModule && (
              ...
              >
                ...
                >
                  ...
                  {(() => {
                    const selectedModule = occupationalTrainingModules.find(m => m.id === activeOccupationalModule);
                        ...
                        <div style={{
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              alert(`🎉 Congratulations! You've completed the ${selectedModule.title} training and earned your certification!`);
                            }}
                          >
                            🚀 Start Training
                          </button>
