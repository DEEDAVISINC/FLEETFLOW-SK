...
export default function PermanentShipperDemo() {
  ...
  return (
    <div style={{
      background: 'linear-gradient(135deg, #7c3aed 0%, #6d28d9 25%, #5b21b6 50%, #4c1d95 75%, #2e1065 100%)',
      minHeight: '100vh',
      ...
      <main style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            Permanent IDs: WMT001, AMZ002, TGT003 | Used in Load IDs: WMT-204-070-FTL-DRY-STD-001-20250115
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Generate a load identifier using the permanent shipper ID with priority rate key
            </p>
        ...
        {(generatedPermanentId || loadIdWithPermanent) && (
          <div style={{
            ...
            <div style={{
              display: 'grid',
              gridTemplateColumns: generatedPermanentId && loadIdWithPermanent ? '1fr 1fr' : '1fr',
              gap: '24px'
            }}>
              ...
              {generatedPermanentId && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Company:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedPermanentId.companyName}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Initials:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedPermanentId.companyInitials}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Transaction:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedPermanentId.transactionCode}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Commodity:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedPermanentId.commodityCode}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Created:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>
                        {new Date(generatedPermanentId.createdAt).toLocaleDateString()}
                      </div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Active:</span>
                      <div style={{ color: generatedPermanentId.isActive ? '#10b981' : '#ef4444', fontWeight: '600' }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>{loadIdWithPermanent.loadId.breakdown.loadType}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Equipment:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{loadIdWithPermanent.loadId.breakdown.equipment}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Priority:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{loadIdWithPermanent.loadId.breakdown.priority}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Sequence:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{loadIdWithPermanent.loadId.breakdown.sequence}</div>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' }}>
                  Shipper ID | Load Type | Equipment | Priority | Sequence | Date
                </div>
              </div>
            </div>
          </div>
