  ...
  const runEDIDemo = async () => {
    ...
    try {
      ...
      results.push({
        ...
        description: 'System automatically generates required EDI identifiers for load posting',
        input: sampleLoad,
        output: loadResult,
      ...
      results.push({
        ...
        description: 'System prepares quote data for EDI transmission with proper identifiers',
        input: sampleQuote,
        output: quoteResult,
      ...
      results.push({
        ...
        description: 'System generates competitive response with EDI-ready identifiers',
        input: sampleRFx,
        output: rfxResult,
      ...
      results.push({
        ...
        description: 'System creates structured shipper IDs combining EDI codes, commodity codes, and company initials',
        input: {
        ...
        output: shipperId,
        ediValidation: { isValid: shipperId.isValid, missingRequired: [], invalidIdentifiers: [] },
        transactionType: 'Shipper ID Format: COMPANY-TRANSACTION-COMMODITY-SEQUENCE-DATE'
      });
      ...
      <main style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            This demonstration shows how the system automatically handles EDI identifiers, validation, and transaction mapping without exposing complexity to users.
          </p>
        </div>
        ...
        <div style={{
          ...
          >
            {isProcessing ? '🔄 Processing EDI Demo...' : '🚀 Run EDI Integration Demo'}
          </button>
          <p style={{
            ...
            This will demonstrate load posting, quote generation, and RFx response with automatic EDI enrichment
          </p>
        </div>
              ...
              <div key={index} style={{
                ...
                {result.transactionType && (
                  <div style={{
                    ...
                    <h4 style={{ color: '#fbbf24', margin: '0 0 8px 0', fontSize: '14px' }}>
                      📋 EDI Transaction Type
                    </h4>
                    <p style={{ color: 'white', margin: 0, fontSize: '16px', fontWeight: '600' }}>
                      {result.transactionType}
                    </p>
                  </div>
                )}
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h3 style={{
                      ...
                      marginBottom: '12px',
                      fontSize: '16px'
                    }}>📤 System Output (Internal EDI-Enhanced)</h3>
                    <pre style={{
                      background: 'rgba(0, 0, 0, 0.3)',
                      borderRadius: '8px',
                      padding: '12px',
                ...
                {result.ediValidation && (
                  <div style={{
                    ...
                    <h3 style={{
                      color: result.ediValidation.isValid ? '#10b981' : '#ef4444',
                      marginBottom: '12px',
                      fontSize: '16px'
                    }}>
                      {result.ediValidation.isValid ? '✅' : '❌'} EDI Validation Results
                    </h3>
                    ...
                    <div style={{
                      ...
                      {result.ediValidation.requiredIdentifiers && (
                        <div>
                          ...
                          <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.8)' }}>
                            {result.ediValidation.requiredIdentifiers.map((id: string) => (
                      ...
                      {result.ediValidation.generatedIdentifiers && (
                        <div>
                          ...
                          <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.8)' }}>
                            {Object.entries(result.ediValidation.generatedIdentifiers).map(([key, value]) => (
                      ...
                      {result.ediValidation.missingRequired && result.ediValidation.missingRequired.length > 0 && (
                        <div>
                          <h4 style={{ color: '#ef4444', fontSize: '14px', marginBottom: '8px' }}>
                            Missing Required
                          </h4>
                          <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.8)' }}>
                            {result.ediValidation.missingRequired.map((id: string) => (
                              <div key={id} style={{ marginBottom: '4px' }}>
                                ❌ {id}
                              </div>
                            ))}
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              ...
              { type: 'PRO', validExample: '12345678901', invalidExample: '123456' },
              { type: 'BOL', validExample: 'BOL123456789', invalidExample: 'BO' },
              { type: 'GLN', validExample: '1234567890123', invalidExample: '12345' },
              { type: 'DUNS', validExample: '123456789', invalidExample: '12345' },
              { type: 'ContainerNumber', validExample: 'ABCD1234567', invalidExample: 'ABC123' }
            ].map((example) => (
              <div key={example.type} style={{
                background: 'rgba(255, 255, 255, 0.1)',
                borderRadius: '12px',
                padding: '20px'
              }}>
                ...
                <div style={{ marginBottom: '12px' }}>
                  <div style={{
                    color: validateIdentifier(example.type, example.validExample) ? '#10b981' : '#ef4444',
                    fontSize: '14px',
                    marginBottom: '4px'
                  }}>
                    {validateIdentifier(example.type, example.validExample) ? '✅' : '❌'} Valid: {example.validExample}
                  </div>
                  <div style={{
                    color: validateIdentifier(example.type, example.invalidExample) ? '#10b981' : '#ef4444',
                    fontSize: '14px'
                  }}>
                    {validateIdentifier(example.type, example.invalidExample) ? '✅' : '❌'} Invalid: {example.invalidExample}
                  </div>
                </div>
              </div>
            ))}
