...
export const getEnvironment = () => {
  ...
  if (process.env.NEXT_PUBLIC_SITE_URL?.includes('fleetflow.vercel.app')) return 'production'
...
export const initializeSupabase = async () => {
  ...
  if (!validation.valid) {
    ...
    throw new Error(`Supabase configuration invalid: ${validation.errors.join(', ')}`)
  }
