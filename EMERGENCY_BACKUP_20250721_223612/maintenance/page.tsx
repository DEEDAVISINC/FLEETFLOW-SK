...
export default function MaintenancePage() {
  ...
  const [activeView, setActiveView] = useState<'overview' | 'schedule' | 'analytics'>('overview')
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case 'inspection': return 'linear-gradient(135deg, #f59e0b, #d97706)'
      case 'repair': return 'linear-gradient(135deg, #10b981, #059669)'
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  fontSize: '14px',
                  background: activeView === tab.id ? 'linear-gradient(135deg, #06b6d4, #0891b2)' : 'rgba(255, 255, 255, 0.1)',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)' }}>Total Records</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)' }}>Pending</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)' }}>In Progress</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)' }}>Overdue</div>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)' }}>Total Cost</div>
              </div>
            </div>
                  ...
                  onMouseOut={(e) => {
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                      ...
                      <div>
                        ...
                        <p style={{ color: 'rgba(255, 255, 255, 0.7)', margin: '0 0 4px 0', fontSize: '14px' }}>
                          {record.description}
                        </p>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                      ...
                      <div style={{
                        ...
                        fontSize: '12px',
                        fontWeight: '600',
                        background: record.status === 'completed' ? 'rgba(74, 222, 128, 0.2)' :
                                   record.status === 'in_progress' ? 'rgba(59, 130, 246, 0.2)' :
                                   record.status === 'overdue' ? 'rgba(239, 68, 68, 0.2)' :
                                   'rgba(251, 191, 36, 0.2)',
                        color: record.status === 'completed' ? '#4ade80' :
                               record.status === 'in_progress' ? '#3b82f6' :
                               record.status === 'overdue' ? '#ef4444' :
                               '#fbbf24',
                        border: `1px solid ${record.status === 'completed' ? '#4ade80' :
                                            record.status === 'in_progress' ? '#3b82f6' :
                                            record.status === 'overdue' ? '#ef4444' :
                                            '#fbbf24'}`
                      }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
                ...
                onMouseOut={(e) => {
                  ...
                  View All ({maintenanceRecords.filter(record => record.status === 'pending' || record.status === 'in_progress').length})
                </button>
              </div>
              
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {maintenanceRecords
                  .filter(record => record.status === 'pending' || record.status === 'in_progress')
                    ...
                    onMouseOut={(e) => {
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        ...
                        <div>
                          ...
                          <p style={{ color: 'rgba(255, 255, 255, 0.7)', margin: 0, fontSize: '12px' }}>
                            {record.technician} • {new Date(record.scheduledDate).toLocaleDateString()}
                          </p>
                        </div>
                      </div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                        ...
                        <div style={{
                          ...
                          fontSize: '12px',
                          fontWeight: '600',
                          background: record.status === 'pending' ? 'rgba(251, 191, 36, 0.2)' : 'rgba(59, 130, 246, 0.2)',
                          color: record.status === 'pending' ? '#fbbf24' : '#3b82f6',
            ...
            <div style={{ padding: '32px' }}>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '32px', marginBottom: '8px' }}>💰</div>
                  <h3 style={{ color: '#fbbf24', fontSize: '24px', fontWeight: 'bold', margin: '0 0 4px 0' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '32px', marginBottom: '8px' }}>⚡</div>
                  <h3 style={{ color: '#10b981', fontSize: '24px', fontWeight: 'bold', margin: '0 0 4px 0' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '32px', marginBottom: '8px' }}>🔧</div>
                  <h3 style={{ color: '#ef4444', fontSize: '24px', fontWeight: 'bold', margin: '0 0 4px 0' }}>
                    {maintenanceRecords.filter(r => r.type === 'repair').length}
                  </h3>
                  <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '14px', margin: 0 }}>
                    Repairs Count
                  </p>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '32px', marginBottom: '8px' }}>📅</div>
                  <h3 style={{ color: '#3b82f6', fontSize: '24px', fontWeight: 'bold', margin: '0 0 4px 0' }}>
                    {maintenanceRecords.filter(r => r.type === 'scheduled').length}
                  </h3>
                  <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '14px', margin: 0 }}>
                    Scheduled Count
                  </p>
              ...
              <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '16px' }}>
                  {['scheduled', 'emergency', 'inspection', 'repair'].map((type) => {
                    const count = maintenanceRecords.filter(r => r.type === type).length;
                    const percentage = ((count / maintenanceRecords.length) * 100).toFixed(1);
                    ...
                    .map((record) => (
                      <div key={record.id} style={{
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                          <div style={{ textAlign: 'center' }}>
                            <div style={{ 
                              color: record.cost > 500 ? '#ef4444' : record.cost > 200 ? '#f59e0b' : '#10b981',
                              fontSize: '18px', 
                              fontWeight: 'bold' 
                            }}>
                              ${record.cost}
