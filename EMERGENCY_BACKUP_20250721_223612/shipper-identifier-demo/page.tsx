...
export default function ShipperIdentifierDemo() {
  ...
  const [testIdentifier, setTestIdentifier] = useState('WMT-204-070-001-20250115');
  ...
  return (
    <div style={{
      background: 'linear-gradient(135deg, #1e40af 0%, #3730a3 25%, #7c3aed 50%, #a855f7 75%, #ec4899 100%)',
      minHeight: '100vh',
      ...
      <main style={{
        ...
        {(generatedId || parsedId) && (
          <div style={{
            ...
            <div style={{
              display: 'grid',
              gridTemplateColumns: generatedId && parsedId ? '1fr 1fr' : '1fr',
              gap: '24px'
            }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedId.breakdown.company}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Transaction:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedId.breakdown.transaction}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Commodity:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedId.breakdown.commodity}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Sequence:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedId.breakdown.sequence}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Date:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{generatedId.breakdown.date}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Valid:</span>
                      <div style={{ color: generatedId.isValid ? '#10b981' : '#ef4444', fontWeight: '600' }}>
              ...
              {parsedId && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Company:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{parsedId.breakdown.company}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Transaction:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{parsedId.breakdown.transaction}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Commodity:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{parsedId.breakdown.commodity}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Sequence:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{parsedId.breakdown.sequence}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Date:</span>
                      <div style={{ color: 'white', fontWeight: '600' }}>{parsedId.breakdown.date}</div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>Valid:</span>
                      <div style={{ color: parsedId.isValid ? '#10b981' : '#ef4444', fontWeight: '600' }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{
                ...
                <div style={{ marginBottom: '8px' }}>
                  <span style={{ color: '#3b82f6' }}>210</span> - Freight Invoice
                </div>
                <div style={{ marginBottom: '8px' }}>
                  <span style={{ color: '#3b82f6' }}>214</span> - Shipment Status
                </div>
                <div style={{ marginBottom: '8px' }}>
                  <span style={{ color: '#3b82f6' }}>856</span> - Ship Manifest
                </div>
                <div style={{ marginBottom: '8px' }}>
                  <span style={{ color: '#3b82f6' }}>990</span> - Tender Response
                </div>
              </div>
            </div>
          </div>
