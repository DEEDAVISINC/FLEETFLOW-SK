  ...
  return (
    <div style={{ 
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '1.2rem', marginBottom: '10px', color: '#374151' }}>
          Connection Status
        </h2>
        <p style={{ 
          fontSize: '1rem', 
          fontWeight: '600',
          color: connectionStatus.includes('✅') ? '#059669' : connectionStatus.includes('❌') ? '#dc2626' : '#f59e0b'
        }}>
          {connectionStatus}
        </p>
        ...
        {error && (
          <div style={{
            ...
            <h3 style={{ color: '#dc2626', marginBottom: '10px' }}>Error Details:</h3>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '1.2rem', marginBottom: '15px', color: '#0c4a6e' }}>
          🔧 Actions
        </h2>
        ...
        <div style={{ marginTop: '20px', fontSize: '0.9rem', color: '#0c4a6e' }}>
          <h3 style={{ marginBottom: '10px' }}>Next Steps:</h3>
          <ul style={{ marginLeft: '20px' }}>
            <li>If connection fails, check your API keys in <code>.env.local</code></li>
            <li>If tables are empty, run the SQL schema in Supabase SQL Editor</li>
            <li>If everything works, your FleetFlow is ready for production!</li>
          </ul>
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ color: '#92400e', fontSize: '0.9rem', margin: 0 }}>
          Visit <a href="/" style={{ color: '#92400e', textDecoration: 'underline' }}>http://localhost:3000</a> to see your main dashboard with real data!
        </p>
      </div>
    </div>
  )
