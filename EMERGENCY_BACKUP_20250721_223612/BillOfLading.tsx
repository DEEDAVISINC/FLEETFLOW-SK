...
const BillOfLading: React.FC<BOLProps> = ({ load, driver, signatures, onPrint }) => {
    ...
    <div style={{
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <div style={{
          ...
          <div>
            <strong>Broker:</strong> {load.brokerName}<br/>
            <strong>Equipment:</strong> {load.equipment}<br/>
            <strong>Weight:</strong> {load.weight}<br/>
            <strong>Distance:</strong> {load.distance}
          </div>
          <div>
            <strong>Rate:</strong> ${load.rate.toLocaleString()}<br/>
            <strong>Pickup Date:</strong> {formatDate(load.pickupDate)}<br/>
            <strong>Delivery Date:</strong> {formatDate(load.deliveryDate)}<br/>
            {signatures.sealNumber && <><strong>Seal Number:</strong> {signatures.sealNumber}</>}
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <strong>Load ID:</strong> {load.id}<br/>
              <strong>Load Identifier:</strong> {(() => {
                try {
                  const EDIService = require('../app/services/EDIService').default;
                  const loadData = {
                    id: load.id,
                    shipperInfo: { companyName: load.origin?.split(',')[0] || 'Unknown' },
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <div style={{
          ...
          <div>
            <strong>CDL Number:</strong> {driver.licenseNumber}<br/>
      ...
      <div style={{
        ...
        <strong>Terms and Conditions:</strong> This Bill of Lading is subject to the terms and conditions of FleetFlow Transportation Services.
        The carrier acknowledges receipt of the described goods in apparent good order and condition unless otherwise noted.
        Signatures above confirm pickup and delivery of cargo as described.
      </div>
