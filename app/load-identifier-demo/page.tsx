...
export default function LoadIdentifierDemo() {
  ...
  const [testLoadIdentifier, setTestLoadIdentifier] = useState(
    'WMT-204-070-FTL-DRY-001-20250115'
  );
  ...
  const generateLoadIdentifier = () => {
    try {
      ...
      alert(
        `Error generating load identifier: ${error instanceof Error ? error.message : 'Unknown error'}`
      );
    }
  };
  ...
  const validateLoadIdentifier = () => {
    ...
    alert(
      `Load Identifier "${testLoadIdentifier}" is ${isValid ? 'VALID' : 'INVALID'}`
    );
  };
  ...
  const generateLoadBoardNumber = () => {
    try {
      ...
      alert(
        `Error generating load board number: ${error instanceof Error ? error.message : 'Unknown error'}`
      );
    }
  };
  ...
  return (
    <div
      style={{
        background:
          'linear-gradient(135deg, #059669 0%, #047857 25%, #065f46 50%, #064e3b 75%, #022c22 100%)',
        minHeight: '100vh',
    ...
    >
      ...
      >
          ...
          >
            ...
            <div
              style={{
                display: 'grid',
                gridTemplateColumns:
                  generatedLoadId && parsedLoadId ? '1fr 1fr' : '1fr',
                gap: '24px',
              }}
            >
                  ...
                  >
                    <div>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>
                        {generatedLoadId.loadId.breakdown.loadType}
                      </div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>
                        {generatedLoadId.loadId.breakdown.equipment}
                      </div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>
                        {generatedLoadId.loadId.breakdown.sequence}
                      </div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>
                        {generatedLoadId.loadId.breakdown.date}
                      </div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>
                      ...
                      <div
                        style={{
                          color: generatedLoadId.loadId.isValid
                            ? '#10b981'
                            : '#ef4444',
                          fontWeight: '600',
                        }}
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>
                        {parsedLoadId.breakdown.loadType}
                      </div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>
                        {parsedLoadId.breakdown.equipment}
                      </div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>
                      ...
                      <div style={{ color: 'white', fontWeight: '600' }}>
                        {parsedLoadId.breakdown.sequence}
                      </div>
                    </div>
                    <div>
                      <span style={{ color: '#fbbf24', fontSize: '12px' }}>
                    ...
                    <div>
                      ...
                      <div
                        style={{
                          color: parsedLoadId.isValid ? '#10b981' : '#ef4444',
                          fontWeight: '600',
                        }}
                      >
        ...
        >
          ...
          >
            Generate simple 6-digit load board numbers for easy phone
            communication
          </p>
          ...
          >
            <div>
              ...
              >
                <option value='FleetFlow Management'>
                  FleetFlow Management (Code: 1)
                </option>
                <option value='Express Logistics'>
                  Express Logistics (Code: 2)
                </option>
                <option value='Reliable Freight'>
                  Reliable Freight (Code: 3)
                </option>
                <option value='Quick Haul Inc'>Quick Haul Inc (Code: 4)</option>
                <option value='Mountain View Transport'>
                  Mountain View Transport (Code: 5)
                </option>
                <option value='ABC Transport LLC'>
                  ABC Transport LLC (Code: 6)
                </option>
                <option value='Premium Carriers'>
                  Premium Carriers (Code: 7)
                </option>
                <option value='Swift Delivery'>Swift Delivery (Code: 8)</option>
                <option value='Elite Logistics'>
                  Elite Logistics (Code: 9)
                </option>
              </select>
            </div>
          ...
          {loadBoardNumber && (
            ...
            >
              ...
              >
                ...
                >
                  <strong>Carrier:</strong> "Hi, I'm calling about load board
                  number {loadBoardNumber.loadBoardNumber}"<br />
                  <strong>Dispatcher:</strong> "Yes, that's load board number{' '}
                  {loadBoardNumber.loadBoardNumber} for{' '}
                  {loadBoardNumber.breakdown.shipperName}, assigned to{' '}
                  {loadBoardNumber.breakdown.dispatcherName}"
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <div style={{ marginBottom: '8px' }}>
                  <span style={{ color: '#3b82f6' }}>LTL</span> - Less Than
                  Truckload
                </div>
                <div style={{ marginBottom: '8px' }}>
