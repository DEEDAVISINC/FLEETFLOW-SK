...
export default function EnhancedNewCarrierButton({
  ...
  const generateInviteLink = () => {
    ...
    const referralCode = `${currentUser.role.substring(0, 3).toUpperCase()}-${currentUser.name
      .split(' ')
      .map((n) => n[0])
      .join('')}-${Date.now()}`;
    const inviteUrl = `${baseUrl}/carrier-landing?ref=${referralCode}&inviter=${encodeURIComponent(currentUser.name)}`;
          ...
          {!showQuickInvite ? (
            ...
            <div style={{ padding: '16px' }}>
              ...
              >
                ...
                >
                  Begin onboarding for Driver OTR Flow Portal access
                </div>
              </button>
              ...
              >
                ...
                <div
                  style={{ color: 'rgba(255,255,255,0.7)', fontSize: '12px' }}
                >
                  Email invitation for Driver OTR Flow Portal access
                </div>
              </button>
              ...
              >
                ...
                <div
                  style={{ color: 'rgba(255,255,255,0.7)', fontSize: '12px' }}
                >
                  Shareable link for Driver OTR Flow Portal access
                </div>
              </button>
