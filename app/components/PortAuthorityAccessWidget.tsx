...
export default function PortAuthorityAccessWidget() {
  const [activeTab, setActiveTab] = useState<
    'overview' | 'appointments' | 'book' | 'twic'
  >('overview');
              ...
              >
                ...
                >
                  ...
                  {appointment.requiresTWIC && (
                    <span
                      style={{
                        background: appointment.escortAssigned
                          ? 'rgba(139, 92, 246, 0.2)'
                          : 'rgba(245, 158, 11, 0.2)',
                        color: appointment.escortAssigned
                          ? '#a78bfa'
                          : '#fbbf24',
                        padding: '2px 6px',
                        borderRadius: '4px',
            ...
            <div style={{ display: 'grid', gap: '12px' }}>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    name='twicCard'
                    placeholder='TWIC Number (if available)'
                    style={{
                      width: '100%',
                      padding: '8px',
                      borderRadius: '6px',
      ...
      {activeTab === 'twic' && (
        <div>
          ...
          >
            ...
            >
              For drivers without TWIC cards, we provide certified escorts to
              access secure port facilities. Our escorts are TWIC-certified and
              familiar with port security procedures.
            </p>
          </div>
