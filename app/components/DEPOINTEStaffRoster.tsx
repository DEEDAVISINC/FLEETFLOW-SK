...
import { enhanceStaffWithAdaptiveLearning } from '../utils/enhanceStaffWithAdaptiveLearning';
...
// 🎭 COMPLETE DEPOINTE AI STAFF ROSTER (without adaptive learning)
const baseDepointeStaffRoster: Omit<DEPOINTEStaffMember, 'adaptiveLearning'>[] =
  [
...

    {
      ...
      personality:
        'Edge case specialist who works with cliff-hanging situations',
      specializations: [
        'Strategic Solutions',
        'Critical Logistics',
    ...
    // 🎯 EXECUTIVE OPERATIONS DEPARTMENT (DAY-TO-DAY MANAGEMENT)
    {
      ...
      avatar: '🎯',
      hint: 'Alexis → Executive Assistant (like executive excellence)',
      personality:
        'Executive powerhouse who manages daily operations with precision and anticipates needs',
      specializations: [
        'Executive Support',
    ...
    // 📞 FRONT OFFICE DEPARTMENT (RECEPTION & COMMUNICATIONS)
    {
      ...
      avatar: '📞',
      hint: 'Riley → Receptionist (like receiving calls)',
      personality:
        'Front office maestro who handles all incoming communications with grace and efficiency',
      specializations: [
        'Client Reception',
    ...
    // 👑 EXECUTIVE LEADERSHIP (SENIOR EXECUTIVE)
    {
      id: 'deeva-deveraux',
      firstName: 'Deeva',
      lastName: 'Deveraux',
      ...
      internalRole: 'Senior Executive',
      customerFacingTitle: 'Senior Executive',
      avatar: '👑',
      hint: 'Deeva Deveraux → Senior Executive (work identity)',
      personality:
        "Dynamic executive leader who drives strategic initiatives and represents DEPOINTE's vision in the freight brokerage industry",
      specializations: [
      ...
      contactMethods: ['phone', 'email', 'linkedin'],
      emailSignature:
        'Deeva Deveraux\nSenior Executive\nDEPOINTE/ Freight 1st Direct\nDriving Strategic Excellence in Freight Brokerage',
    },
  ];

// 🧠 ENHANCED STAFF ROSTER WITH ADAPTIVE LEARNING
export const depointeStaffRoster: DEPOINTEStaffMember[] =
  baseDepointeStaffRoster.map((staff) =>
    enhanceStaffWithAdaptiveLearning(staff)
  );
