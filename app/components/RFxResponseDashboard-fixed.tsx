...
const RFxResponseDashboard: React.FC = () => {
  const [activeTab, setActiveTab] = useState<
    'requests' | 'intelligence' | 'responses' | 'analytics'
  >('requests');
                  ...
                  >
                      ...
                      <div className='flex items-center space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-gray-600'>
                            {request.company} • {request.location}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className='mb-4 grid grid-cols-2 gap-4 md:grid-cols-4'>
                      ...
                      <div>
                        ...
                        <p className='font-semibold text-gray-900'>
                          {request.lanes?.length || 0}
                        </p>
                      </div>
                      <div>
                        <span className='text-sm text-gray-500'>Distance</span>
                        <p className='font-semibold text-gray-900'>
                          {request.totalMiles || 'N/A'} mi
                        </p>
                      </div>
                    </div>
              ...
              <>
                ...
                <div className='rounded-xl bg-white p-6 shadow-sm'>
                  ...
                  <div className='space-y-4'>
                    ...
                    {selectedRequest.lanes &&
                      selectedRequest.lanes.length > 0 && (
                        <div>
                          <span className='text-sm text-gray-500'>
                            Lane Information
                          </span>
                            ...
                            {selectedRequest.lanes.map((lane, index) => (
                              ...
                              >
                                ...
                                <div className='mt-1 text-sm text-gray-600'>
                                  Equipment: {lane.equipmentType} • Weight:{' '}
                                  {lane.weight} lbs
                                </div>
                              </div>
                            ))}
                  ...
                  <div className='rounded-xl bg-white p-6 shadow-sm'>
                    ...
                    <div className='space-y-4'>
                      ...
                      <div>
                        ...
                        <div className='mt-2 space-y-1'>
                          {marketIntelligence.demandTrends?.map(
                            (trend, index) => (
                              <div
                                key={index}
