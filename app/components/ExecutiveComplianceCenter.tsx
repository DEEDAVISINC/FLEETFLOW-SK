        ...
        <div>
          ...
          >
            {[
              {
                title: 'FMCSA Filings',
                forms: ['MCS-150', 'UCR Registration'],
                color: '#3b82f6',
              },
              {
                title: 'State Registrations',
                forms: ['IRP Registration', 'State Permits'],
                color: '#22c55e',
              },
              {
                title: 'Financial Reports',
                forms: ['Annual Reports', 'Audit Results'],
                color: '#f59e0b',
              },
              {
                title: 'Safety Filings',
                forms: ['Safety Audits', 'Violation Reports'],
                color: '#ef4444',
              },
            ].map((category, index) => (
              <div
          ...
          >
            <h4
              style={{ color: 'white', fontSize: '12px', marginBottom: '8px' }}
            >
