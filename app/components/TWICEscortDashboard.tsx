...
export default function TWICEscortDashboard() {
  const [activeTab, setActiveTab] = useState<
    'overview' | 'requests' | 'escorts' | 'analytics'
  >('overview');
    ...
    >
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '18px' }}>
          Professional escort services for drivers without TWIC cards at secure
          port facilities
        </p>
      </div>
          ...
          >
            ...
            >
              ...
              >
                {analytics
                  ? Math.round(
                      (analytics.completedRequests / analytics.totalRequests) *
                        100
                    )
                  : 0}
                %
              ...
              <div
                style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.7)' }}
              >
                {analytics?.completedRequests} of {analytics?.totalRequests}{' '}
                requests
              </div>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    'Round-the-clock escort services for all port facilities',
                  icon: '🕒',
                  features: [
                    'Emergency escorts',
                    'Weekend service',
                ...
                },
                {
                  ...
                  description:
                    'Live updates and GPS tracking of escort services',
                  icon: '📍',
                  features: [
                    'Live location',
                    'ETA updates',
                ...
                <div style={{ flex: 1 }}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span style={{ color: 'white' }}>
                        {formatDateTime(request.appointmentTime)}
                      </span>
                    </div>
                    <div>
                      <span style={{ color: 'rgba(255, 255, 255, 0.6)' }}>
              ...
              >
                ...
                >
                  <div
                    style={{
                      ...
                      borderRadius: '50%',
                      background:
                        escort.status === 'available' ? '#10b981' : '#f59e0b',
                    }}
                  />
                  <h3
                  ...
                  <span style={{ color: '#fbbf24' }}>{escort.rating}⭐</span>
                </div>
                ...
                <button
                  style={{
                    ...
                    fontWeight: '500',
                    cursor:
                      escort.status === 'available' ? 'pointer' : 'not-allowed',
                    width: '100%',
                  }}
                >
                  {escort.status === 'available'
