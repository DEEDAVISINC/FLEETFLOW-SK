  ...
  return (
    ...
    >
      ...
      >
        {quantumEnabled ? (
          <div>
            <strong>🔬 Quantum Mode Active:</strong> Using advanced
            quantum-inspired algorithms including:
          ...
          <div>
            <strong>⚡ Classical Mode:</strong> Using traditional optimization
            algorithms with nearest-neighbor heuristics and constraint
            satisfaction. Enable Quantum Mode for up to 25% better route
            efficiency.
          </div>
        )}
      </div>
      ...
      {quantumEnabled && (
        <div style={{ marginTop: '16px' }}>
          ...
          >
            {showAdvanced
              ? '⬆️ Hide Advanced Parameters'
              : '⬇️ Show Advanced Parameters'}
          </button>
