        ...
        <div style={{ 
          ...
          <div style={{ position: 'relative', display: 'inline-block' }}>
            ...
            <div style={{
              ...
              <Link href="/dispatch" onClick={handleDropdownClose} style={{ 
                display: 'block', 
                padding: '10px 20px', 
                color: '#3b82f6', 
                textDecoration: 'none', 
              ...
              <Link href="/broker" onClick={handleDropdownClose} style={{ 
                display: 'block', 
                padding: '10px 20px', 
                color: '#3b82f6', 
                textDecoration: 'none', 
          ...
          <div style={{ position: 'relative', display: 'inline-block' }}>
            ...
            <div style={{
              ...
              <Link href="/drivers" onClick={handleDropdownClose} style={{ 
                display: 'block', 
                padding: '10px 20px', 
                color: '#f4a832', 
                textDecoration: 'none', 
              ...
              <Link href="/drivers/enhanced-portal" onClick={handleDropdownClose} style={{ 
                display: 'block', 
                padding: '10px 20px', 
                color: '#f4a832', 
                textDecoration: 'none', 
              ...
              <Link href="/carriers/enhanced-portal" onClick={handleDropdownClose} style={{ 
                display: 'block', 
                padding: '10px 20px', 
                color: '#f4a832', 
                textDecoration: 'none', 
