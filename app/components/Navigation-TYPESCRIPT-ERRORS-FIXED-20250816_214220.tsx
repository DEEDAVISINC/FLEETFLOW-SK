                  ...
                  <div style={{ position: 'relative' }}>
                    ...
                    {activeSubDropdown === 'broker' && (
                      ...
                      >
                        ...
                        <Link
                          href='/broker/dashboard?tab=ai-intelligence-hub'
                          onClick={handleDropdownClose}
                          style={{
                            display: 'block',
                            padding: '8px 16px',
                        ...
                        <Link
                          href='/broker/dashboard?tab=contracts-bol'
                          onClick={handleDropdownClose}
                          style={{
                            display: 'block',
                            padding: '8px 16px',
                ...
                >
                  ...
                  <div style={{ display: 'grid', gap: '6px' }}>
                    ...
                    >
                      ...
                      >
                        {(permissions as any)?.canEditLoads ? '✓ Full' : '✗ Limited'}
                      </span>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      ...
                      >
                        {(permissions as any)?.canViewAllLoads ? '✓ Full' : '✗ Limited'}
                      </span>
                    </div>
                    <div
                      style={{
