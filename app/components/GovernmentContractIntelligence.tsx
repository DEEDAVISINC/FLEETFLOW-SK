...
export default function GovernmentContractIntelligence() {
  const [activeTab, setActiveTab] = useState<
    'overview' | 'contracts' | 'competitors' | 'agencies' | 'geography'
  >('overview');
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            ...
            >
              USAspending.gov API • Transportation Market Analysis • $2.5B+
              Annual Opportunity
            </p>
            ...
            <div style={{ display: 'grid', gap: '24px' }}>
              ...
              >
                ...
                >
                  ...
                  >
                    {formatPercentage(
                      marketIntel.competitive_landscape.market_concentration
                    )}
                  </div>
                  <div
                    style={{
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        {competitor.total_contracts} contracts •{' '}
                        {formatPercentage(competitor.market_share)} market share
                      </div>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <div
                      ...
                      >
                        {competitor.growth_trend > 0 ? '📈' : '📉'}{' '}
                        {formatPercentage(Math.abs(competitor.growth_trend))}{' '}
                        growth
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        {agency.contract_count} contracts •{' '}
                        {formatCurrency(agency.avg_contract_size)} average
                      </div>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <div
                      ...
                      >
                        <div
                          style={{
                            background:
                              agency.opportunity_score > 0.8
                                ? '#10b981'
                                : agency.opportunity_score > 0.6
                                  ? '#f59e0b'
                                  : '#ef4444',
                            color: 'white',
                            padding: '4px 8px',
                        ...
                        >
                          {Math.round(agency.opportunity_score * 100)}%
                          Opportunity
                        </div>
                      </div>
                    </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        {geo.contract_count} contracts •{' '}
                        {formatPercentage(geo.market_saturation)} saturation
                      </div>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                      <div
