...
export default function RouteOptimizerDashboard({
  ...
  return (
    <div style={{ color: 'white' }}>
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      {vehicle.capacity.toLocaleString()} lbs • {vehicle.mpg}{' '}
                      MPG
                    </div>
                  </div>
                  <div
                ...
                >
                  <div>
                    ...
                    >
                      ...
                      {stop.weight?.toLocaleString() || 0} lbs
                    </div>
                  </div>
                  <div
                    style={{
            ...
            >
              {optimizedRoutes.map((route) => (
                <div
                  ...
                  style={{
                    background:
                      selectedRoute?.vehicleId === route.vehicleId
                        ? 'rgba(33, 150, 243, 0.3)'
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        {route.totalDistance.toFixed(0)} mi
                      </div>
                      <div
                        style={{
                          fontSize: '0.8rem',
              ...
              <div className='grid grid-cols-2 gap-4'>
                <div>
                  ...
                  <div className='text-lg font-medium'>
                    {selectedRoute.totalDistance.toFixed(1)} miles
                  </div>
                </div>
                <div>
                  <div className='text-sm text-gray-500'>Duration</div>
                  <div className='text-lg font-medium'>
                    {Math.round(selectedRoute.totalDuration)} min
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className='text-lg font-medium'>
                    ${selectedRoute.estimatedCost.toFixed(2)}
                  </div>
                </div>
              </div>

              <div>
                <div className='mb-2 text-sm text-gray-500'>Stop Sequence</div>
      ...
      {/* Add Stop Modal */}
      {showAddStop && (
        <StopForm onSubmit={addStop} onCancel={() => setShowAddStop(false)} />
      )}
  ...
  return (
    <div className='bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black'>
      <div className='w-full max-w-md rounded-lg bg-white p-6'>
        <h3 className='mb-4 text-lg font-semibold'>Add New Vehicle</h3>
          ...
          <div className='grid grid-cols-3 gap-4'>
            ...
            <div>
              ...
              <input
                ...
                value={formData.mpg}
                onChange={(e) =>
                  setFormData({ ...formData, mpg: parseFloat(e.target.value) })
                }
                className='w-full rounded border border-gray-300 px-3 py-2'
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    maxDrivingHours: parseInt(e.target.value),
                  })
                }
                className='w-full rounded border border-gray-300 px-3 py-2'
              />
...
function StopForm({
  ...
  return (
    <div className='bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black'>
      <div className='w-full max-w-md rounded-lg bg-white p-6'>
        <h3 className='mb-4 text-lg font-semibold'>Add New Stop</h3>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    priority: e.target.value as Stop['priority'],
                  })
                }
                className='w-full rounded border border-gray-300 px-3 py-2'
              >
