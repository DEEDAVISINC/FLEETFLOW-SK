      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div>
            ...
            >
              Bureau of Labor Statistics • Driver Wages • Employment Trends •
              Regional Analysis • Shortage Intelligence
            </p>
            ...
            <div style={{ display: 'grid', gap: '24px' }}>
              ...
              >
                ...
                >
                  ...
                  >
                    {formatCurrency(
                      dashboardData.driverWages[0]?.annual_wage_median || 0
                    )}
                  </div>
                  <div
                    style={{
                ...
                >
                  ...
                  >
                    {formatNumber(
                      dashboardData.shortageAnalysis.shortage_estimate
                    )}
                  </div>
                  <div
                    style={{
                ...
                >
                  ...
                  >
                    {formatNumber(
                      dashboardData.employmentTrends[0]?.job_openings_annual ||
                        0
                    )}
                  </div>
                  <div
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ color: 'white', fontSize: '14px' }}>
                      {formatPercentage(
                        dashboardData.shortageAnalysis.market_response
                          .wage_premium
                      )}{' '}
                      wage premium
                    </div>
                    ...
                    .map((region, index) => (
                      ...
                      >
                        <div>
                          ...
                          >
                            {formatNumber(region.driver_employment)} drivers •{' '}
                            {formatPercentage(region.job_growth_rate)} growth
                          </div>
                        </div>
                ...
                >
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        {formatNumber(wage.employment_level)} employed •{' '}
                        {formatPercentage(wage.year_over_year_change)} YoY
                        change
                      </div>
                    </div>
                    <div style={{ textAlign: 'right' }}>
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      >
                        {formatPercentage(
                          trend.employment_change_percent / 100
                        )}
                      </div>
                      <div
                        style={{
                  ...
                  <div style={{ marginBottom: '16px' }}>
                    ...
                    >
                      ...
                      <div style={{ textAlign: 'center' }}>
                        ...
                        >
                          {formatCurrency(
                            comparison.wage_data.national_average
                          )}
                        </div>
                        <div
                          style={{
                  ...
                  <div>
                    ...
                    >
                      <div style={{ textAlign: 'center' }}>
                        ...
                        >
                          {formatPercentage(
                            comparison.benefits_data.health_insurance
                          )}
                        </div>
                        <div
                          style={{
                      ...
                      <div style={{ textAlign: 'center' }}>
                        ...
                        >
                          {formatPercentage(
                            comparison.benefits_data.retirement_plan
                          )}
                        </div>
                        <div
                          style={{
                      ...
                      <div style={{ textAlign: 'center' }}>
                        ...
                        >
                          {formatPercentage(
                            comparison.benefits_data.paid_time_off
                          )}
                        </div>
                        <div
                          style={{
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'right' }}>
                      ...
                      >
                        ...
                        {formatPercentage(indicator.change_percent)}
                      </div>
                    </div>
                  </div>
                  <div
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      {dashboardData.shortageAnalysis.contributing_factors.map(
                        (factor, index) => (
                  ...
                  <div style={{ display: 'grid', gap: '8px' }}>
                    ...
                    >
                      ...
                      <span style={{ color: 'white', fontSize: '14px' }}>
                        {
                          dashboardData.shortageAnalysis.demographic_analysis
                            .average_age
                        }{' '}
                        years
                      </span>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <div
                        style={{
                          background:
                            pkg.experience_level === 'entry'
                              ? '#10b981'
                              : pkg.experience_level === 'mid'
                                ? '#f59e0b'
                                : '#ef4444',
                          color: 'white',
                          padding: '4px 8px',
                  ...
                  >
                    <div>
                      ...
                      >
                        Salary: {formatCurrency(pkg.base_salary.min)} -{' '}
                        {formatCurrency(pkg.base_salary.max)}
                      </div>
                      <div
                        style={{
                          color: 'rgba(255, 255, 255, 0.8)',
                      ...
                      >
                        Hourly: {formatCurrency(pkg.hourly_rate.min)} -{' '}
                        {formatCurrency(pkg.hourly_rate.max)}
                      </div>
                    </div>
                    <div>
                      <h5
                    ...
                    <div>
                      ...
                      >
                        Performance:{' '}
                        {formatCurrency(
                          pkg.additional_compensation.performance_bonus
                        )}
                      </div>
                      <div
                        style={{
                      ...
                      >
                        Safety:{' '}
                        {formatCurrency(
                          pkg.additional_compensation.safety_bonus
                        )}
                      </div>
                      <div
                        style={{
                      ...
                      >
                        Referral:{' '}
                        {formatCurrency(
                          pkg.additional_compensation.referral_bonus
                        )}
                      </div>
                    </div>
                  </div>
