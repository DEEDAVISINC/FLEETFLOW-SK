...
import type {
  ...
  FreightProspect,
  LoadDetails,
} from '../services/FreightBrokerAgentSystem';
            ...
            >
              {[
                ...
                },
                {
                  name: 'Trade.gov',
                  status: 'Connected',
                  description: 'Trade verification',
                },
              ].map((api, i) => (
                <div
                  key={i}
          ...
          >
            {agents.map((agent) => (
              ...
              >
                ...
                >
                  {Object.entries(agent.performance)
                    .slice(0, 4)
                    .map(([key, value]) => (
                      <div
                        key={key}
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{
                        background:
                          prospect.lead_score > 80 ? '#10b981' : '#f59e0b',
                        color: 'white',
                        padding: '4px 8px',
                        borderRadius: '12px',
                        fontSize: '0.8rem',
                  ...
                  >
                    {prospect.industry} • $
                    {prospect.opportunity_value.toLocaleString()} opportunity
                  </div>

                  <div style={{ fontSize: '0.8rem', color: '#6b7280' }}>
                    <strong>Contact:</strong>{' '}
                    {prospect.contact_info.primary_contact}
                    <br />
                    <strong>Next Actions:</strong>{' '}
                    {prospect.next_actions.slice(0, 2).join(', ')}
                  </div>
                </div>
              ))
            ) : (
                ...
                >
                  ...
                  >
                    ...
                    <div
                      style={{
                        background:
                          load.status === 'delivered' ? '#10b981' : '#f59e0b',
                        color: 'white',
                        padding: '4px 8px',
                        borderRadius: '12px',
                        fontSize: '0.8rem',
                  ...
                  <div style={{ fontSize: '0.8rem', color: '#6b7280' }}>
                    ...
                    <br />
                    <strong>Equipment:</strong> {load.equipment_type}
                    <br />
