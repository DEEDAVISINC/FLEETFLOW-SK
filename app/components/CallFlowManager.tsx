    ...
    >
      ...
      >
        ...
        <span style={{ color: '#22c55e', fontSize: '12px' }}>
          ...
          •{' '}
          {(callQueues || []).filter((q) => q.isActive).length === 0
            ? 'No Queues Configured'
            : `${(callQueues || []).filter((q) => q.isActive).length} Active Queues`}{' '}
          •{' '}
      ...
      <div style={{ height: 'calc(100% - 140px)', overflow: 'auto' }}>
              ...
              {(agents || []).length === 0 ? (
                ...
                >
                  ...
                  <div style={{ fontSize: '12px' }}>
                    Configure call center agents to start routing calls
                  </div>
                </div>
              ) : (
                (agents || []).map((agent) => (
        ...
        {activeTab === 'test' && (
          <div>
            ...
            {(agents || []).length === 0 && (callQueues || []).length === 0 ? (
              <div
                style={{
                  background: 'rgba(255, 255, 255, 0.05)',
                  border: '1px solid rgba(255, 255, 255, 0.1)',
              ...
              >
                ...
                <div style={{ fontSize: '12px' }}>
                  Configure agents and queues to enable call flow testing
                </div>
              </div>
            ) : (
              <div
