  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20'>
      <div className='space-y-8 p-6'>
        {/* Header with Logo */}
        <div className='relative overflow-hidden rounded-2xl bg-gradient-to-r from-green-600 via-teal-600 to-blue-600 shadow-2xl'>
          ...
          <div className='relative p-8'>
            <div className='flex items-center justify-between'>
              ...
              <button
                className='rounded-xl border border-white/20 bg-white/20 px-6 py-3 font-semibold text-white backdrop-blur-sm transition-all duration-300 hover:border-white/40 hover:bg-white/30'
                style={{
          ...
          <div className='absolute top-0 right-0 -mt-16 -mr-16 h-32 w-32 rounded-full bg-white/10 blur-xl' />
          <div className='absolute bottom-0 left-0 -mb-8 -ml-8 h-24 w-24 rounded-full bg-teal-400/20 blur-lg' />
        </div>
          ...
          <div className='rounded-2xl border border-gray-200/50 bg-white/80 p-6 shadow-lg backdrop-blur-sm transition-all duration-300 hover:shadow-xl'>
            <div className='flex items-center space-x-4'>
              <div className='flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r from-purple-500 to-purple-600'>
                <span className='text-xl font-bold text-white'>
                  {Math.round(
                    vehicles.reduce((acc, v) => acc + v.fuelLevel, 0) /
                      vehicles.length
                  )}
                </span>
              </div>
        ...
        <div className='rounded-2xl border border-gray-200/50 bg-white/80 p-6 shadow-lg backdrop-blur-sm transition-all duration-300 hover:shadow-xl'>
          ...
          <div className='grid grid-cols-1 gap-6 md:grid-cols-3'>
            <div>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className='w-full rounded-xl border border-gray-200 bg-white/80 py-3 pr-4 pl-10 backdrop-blur-sm transition-all duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500'
                  value={searchTerm}
            ...
            <div>
              ...
              <select
                className='w-full rounded-xl border border-gray-200 bg-white/80 px-4 py-3 backdrop-blur-sm transition-all duration-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500'
                value={statusFilter}
            ...
            <div>
              ...
              <button className='w-full transform rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-3 font-semibold text-white shadow-lg transition-all duration-300 hover:-translate-y-0.5 hover:from-indigo-600 hover:to-purple-700 hover:shadow-xl'>
                📊 Export List
              </button>
            </div>
          </div>
              ...
              >
                <div className='p-6'>
                  <div className='mb-4 flex items-center justify-between'>
                    ...
                    <span
                      className={`rounded-full px-3 py-1 text-sm font-medium ${getStatusBadge(vehicle.status)}`}
                    >
                      {vehicle.status}
                    </span>
                  </div>
                  ...
                  <div className='space-y-3'>
                    ...
                    <div className='flex items-center text-sm text-gray-600'>
                      <span className='mr-2 w-4'>🔧</span>
                      <span className='mr-2 font-medium'>Next Service:</span>
                  ...
                  <div className='mt-6 flex space-x-3'>
                    <button
                      className='flex-1 transform rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 px-4 py-2 font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:from-blue-600 hover:to-blue-700'
                      style={{
                        background: 'linear-gradient(135deg, #14b8a6, #0d9488)',
                        color: 'white',
                      }}
                    ...
                    <button
                      className='flex-1 rounded-lg bg-gray-100 px-4 py-2 font-medium text-gray-700 transition-all duration-300 hover:bg-gray-200'
                      style={{
                        background: 'linear-gradient(135deg, #14b8a6, #0d9488)',
                        color: 'white',
                      }}
