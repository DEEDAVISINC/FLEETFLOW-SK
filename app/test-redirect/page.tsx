...
export default function TestRedirectPage() {
  ...
  const testLocalStorage = () => {
    ...
    try {
      ...
      if (readData) {
        ...
        results.push('✅ Read from localStorage: SUCCESS - ' + JSON.stringify(parsed));
      } else {
  ...
  const testRedirect = () => {
    ...
    // Test redirect
    console.log('🧪 Testing redirect to vendor portal...');
    ...
    <div style={{ padding: '40px', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ background: '#fef3c7', padding: '20px', borderRadius: '8px', marginTop: '20px' }}>
        ...
        <ol>
          ...
          <li>If redirect fails, check if vendor portal page loads at /vendor-portal</li>
        </ol>
      </div>
    </div>
  );
