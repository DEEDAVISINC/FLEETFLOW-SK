...
import { dispatchQuizQuestions, brokerQuizQuestions, complianceQuizQuestions } from '../data/quizQuestions'
...
class DynamicQuizGenerator {
  private quizConfigs: { [moduleId: string]: QuizConfig } = {
    ...
    broker: {
      ...
      timeLimit: 35,
      allowRetakes: true,
      questionTypes: ['carrier-management', 'negotiation', 'documentation', 'risk-management']
    },
    compliance: {
      moduleId: 'compliance',
      totalQuestions: 8,
    ...
    safety: {
      ...
      timeLimit: 25,
      allowRetakes: true,
      questionTypes: ['protocols', 'incident-management', 'prevention', 'training']
    },
    technology: {
      moduleId: 'technology',
      totalQuestions: 6,
      ...
      timeLimit: 20,
      allowRetakes: true,
      questionTypes: ['system-navigation', 'features', 'troubleshooting', 'integration']
    },
    customer: {
      moduleId: 'customer',
      totalQuestions: 6,
      ...
      timeLimit: 20,
      allowRetakes: true,
      questionTypes: ['communication', 'problem-solving', 'relationship-management', 'service-excellence']
    }
  }
  ...
  private getModuleQuestions(moduleId: string): QuizQuestion[] {
    switch (moduleId) {
      case 'dispatch':
        return dispatchQuizQuestions.map(q => ({ ...q, difficulty: 'medium' as const, topic: 'dispatch' }))
      case 'broker':
        return brokerQuizQuestions.map(q => ({ ...q, difficulty: 'hard' as const, topic: 'brokerage' }))
      case 'compliance':
        return complianceQuizQuestions.map(q => ({ ...q, difficulty: 'medium' as const, topic: 'compliance' }))
      case 'safety':
  ...
  private generateSafetyQuestions(): QuizQuestion[] {
    return [
      {
        id: 'safety_1',
        question: 'What is the first priority in any transportation safety incident?',
        options: [
        ...
        correctAnswer: 1,
        explanation: 'Personal safety and emergency response always take precedence over documentation or operational concerns.',
        difficulty: 'easy',
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation: 'Regular quarterly safety training with ongoing reinforcement ensures continuous awareness and skill development.',
        difficulty: 'medium',
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation: 'Near-misses and potential incidents should be reported to improve safety protocols and prevent future accidents.',
        difficulty: 'medium',
  ...
  private generateTechnologyQuestions(): QuizQuestion[] {
    return [
      {
        id: 'tech_1',
        question: 'What should you do if the FleetFlow system is not responding?',
        options: [
        ...
        correctAnswer: 1,
        explanation: 'Systematic troubleshooting ensures quick resolution and proper documentation of technical issues.',
        difficulty: 'easy',
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation: 'Regular saving prevents data loss and ensures real-time updates for other team members.',
        difficulty: 'easy',
    ...
    return [
      {
        ...
        correctAnswer: 1,
        explanation: 'Active listening and solution-focused responses de-escalate situations and maintain customer relationships.',
        difficulty: 'medium',
        topic: 'conflict-resolution'
      },
      {
        id: 'customer_2',
        question: 'What information should you always have ready when speaking with customers?',
        options: [
        ...
        correctAnswer: 1,
        explanation: 'Comprehensive information allows for efficient communication and demonstrates professionalism.',
        difficulty: 'easy',
        topic: 'preparation'
      }
    ]
  ...
  addQuestionsToModule(moduleId: string, newQuestions: QuizQuestion[]): void {
    ...
    console.log(`Adding ${newQuestions.length} questions to ${moduleId} module`)
  ...
  updateQuizConfig(moduleId: string, updates: Partial<QuizConfig>): void {
    if (this.quizConfigs[moduleId]) {
      this.quizConfigs[moduleId] = { ...this.quizConfigs[moduleId], ...updates }
    }
  }
