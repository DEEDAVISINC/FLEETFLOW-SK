      ...
      <div style={{ padding: '60px 40px' }}>
        <div style={{ textAlign: 'center', marginBottom: '40px' }}>
          ...
          <div style={{
            ...
            <p style={{
              ...
              Advanced {userRole === 'broker' ? 'Broker' : 'Dispatcher'} Certification
            </p>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#1e40af' }}>{score}%</div>
            <div style={{ color: '#64748b', fontWeight: 'bold' }}>Final Score</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ color: '#64748b', fontWeight: 'bold' }}>Completion Date</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ color: '#64748b', fontWeight: 'bold' }}>Role Certification</div>
          </div>
        </div>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={index} style={{
                ...
                <span style={{ color: '#374151', fontWeight: 'bold' }}>{module}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            <br />
            Continuing education and periodic refresher training are recommended.
          </p>
