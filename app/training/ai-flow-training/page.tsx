...
export default function AIFlowTrainingPage() {
  ...
  const trainingModules = [
    ...
    },
    {
      ...
      duration: '20 min',
      difficulty: 'Intermediate',
      description: 'Leveraging free APIs for business intelligence and prospecting',
      lessons: [
        'OpenCorporates API',
    ...
    },
    {
      ...
      duration: '35 min',
      difficulty: 'Advanced',
      description: 'Complete guide to all 14 free API integrations',
      lessons: [
        'API Overview',
    ...
    },
    {
      ...
      duration: '18 min',
      difficulty: 'Beginner',
      description: 'System metrics, performance tracking, and business analytics',
      lessons: [
        'Performance Metrics',
        'Business Analytics',
        'Custom Reports',
    ...
    },
    {
      ...
      description: 'Complete certification exam and earn your AI Flow certificate',
      lessons: [
        'Review Materials',
        'Practice Questions',
        'Certification Exam',
  ...
  const renderModuleContent = (moduleId: string) => {
    ...
    return (
      <div className="space-y-6">
        ...
        {moduleId === 'voice-infrastructure' && renderVoiceInfrastructureModule()}
        {moduleId === 'business-intelligence' && renderBusinessIntelligenceModule()}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700">
            AI Flow is the ultimate AI freight brokerage platform that revolutionizes transportation logistics through intelligent automation. 
            It combines 8 specialized AI agents with 14 free API integrations to create a comprehensive, zero-cost solution for freight operations.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-800 mb-2">Key Components</h4>
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• 8 Specialized AI Agents</li>
                <li>• 14 Free API Integrations</li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center">
                <div className="bg-white p-4 rounded-lg shadow-sm mb-2">
                  ...
                  <div className="font-semibold text-gray-800">AI Agents Layer</div>
                  <div className="text-sm text-gray-600">8 Specialized Agents</div>
                </div>
                <div className="text-xs text-gray-500">Processing & Intelligence</div>
              </div>
              <div className="text-center">
                <div className="bg-white p-4 rounded-lg shadow-sm mb-2">
                  <Globe className="w-8 h-8 text-green-600 mx-auto mb-2" />
                  <div className="font-semibold text-gray-800">API Integration Layer</div>
                  <div className="text-sm text-gray-600">14 Free APIs</div>
                </div>
                <div className="text-xs text-gray-500">Data & Communication</div>
              </div>
              <div className="text-center">
                <div className="bg-white p-4 rounded-lg shadow-sm mb-2">
                  <Phone className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                  <div className="font-semibold text-gray-800">Voice Infrastructure</div>
                  <div className="text-sm text-gray-600">FreeSWITCH Platform</div>
                </div>
                <div className="text-xs text-gray-500">Communication & Support</div>
              </div>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="bg-red-50 p-4 rounded-lg text-center">
              ...
              <div className="text-sm text-gray-600">Traditional Monthly API Costs</div>
            </div>
  ...
  const renderAgentsModule = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700">
            AI Flow employs 8 specialized AI agents, each designed for specific freight brokerage functions. 
            These agents work collaboratively to automate the entire freight process from lead generation to delivery completion.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: 'Prospecting Agent', icon: Target, tasks: 1247, success: 73, color: 'blue' },
              { name: 'Cold Calling Agent', icon: Phone, tasks: 892, success: 34, color: 'purple' },
              { name: 'Rate Quoting Agent', icon: Calculator, tasks: 2134, success: 89, color: 'green' },
              { name: 'Load Coordinator', icon: Truck, tasks: 1567, success: 96, color: 'orange' },
              { name: 'Customer Service', icon: Headphones, tasks: 3421, success: 94, color: 'pink' },
              { name: 'Compliance Agent', icon: Shield, tasks: 756, success: 98, color: 'indigo' },
              { name: 'Market Analyst', icon: TrendingUp, tasks: 234, success: 91, color: 'red' },
              { name: 'Dispatch Agent', icon: MapPin, tasks: 1876, success: 97, color: 'yellow' }
            ].map((agent, index) => (
              <div key={index} className={`bg-${agent.color}-50 p-4 rounded-lg border border-${agent.color}-200`}>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-gray-50 p-4 rounded-lg">
            <h4 className="font-semibold text-gray-800 mb-2">Agent Monitoring</h4>
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <h4 className="font-semibold text-blue-800 mb-2">Agent Configuration</h4>
            <ul className="text-sm text-blue-700 space-y-1">
  ...
  const renderVoiceInfrastructureModule = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700">
            FreeSWITCH powers our voice infrastructure, providing enterprise-grade telephony capabilities completely free. 
            This open-source platform handles all voice communications for AI agents and human operators.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-purple-50 p-4 rounded-lg">
              <h4 className="font-semibold text-purple-800 mb-2">Core Features</h4>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <h4 className="font-semibold text-blue-800 mb-2">Real-time Monitoring</h4>
  ...
  const renderBusinessIntelligenceModule = () => (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            Free Business Intelligence APIs
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-gray-700">
            Our business intelligence system leverages completely free government and public APIs to provide comprehensive market data, 
            company information, and economic indicators without any ongoing costs.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { name: 'OpenCorporates', desc: 'Company registration data', status: 'FREE' },
              { name: 'SEC EDGAR', desc: 'Public company filings', status: 'FREE' },
              { name: 'Census Bureau', desc: 'Business patterns data', status: 'FREE' },
              { name: 'Bureau of Labor Statistics', desc: 'Employment data', status: 'FREE' },
              { name: 'FRED Economic Data', desc: 'Economic indicators', status: 'FREE' },
              { name: 'Bureau of Transportation', desc: 'Transportation statistics', status: 'FREE' }
            ].map((api, index) => (
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <h4 className="font-semibold text-blue-800 mb-3">5-Step Lead Discovery</h4>
  ...
  const renderFreightOperationsModule = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700">
            The load management system coordinates all freight operations from initial booking through delivery completion, 
            utilizing AI agents for optimal carrier matching and route planning.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-purple-50 p-4 rounded-lg">
            <h4 className="font-semibold text-purple-800 mb-2">Network Optimization</h4>
            <ul className="text-sm text-purple-700 space-y-1">
  ...
  const renderPricingQuotingModule = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700">
            Our AI-powered pricing engine analyzes market conditions, fuel costs, and demand patterns to generate competitive quotes 
            that maximize profitability while maintaining market competitiveness.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-green-50 p-4 rounded-lg">
              <h4 className="font-semibold text-green-800 mb-2">Pricing Factors</h4>
              <ul className="text-sm text-green-700 space-y-1">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <h4 className="font-semibold text-blue-800 mb-2">Quote Generation</h4>
              <ul className="text-sm text-blue-700 space-y-1">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            14 Free API Categories
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { category: 'Voice Infrastructure', apis: ['FreeSWITCH'], icon: Phone },
              { category: 'Business Intelligence', apis: ['OpenCorporates', 'SEC EDGAR'], icon: TrendingUp },
              { category: 'Speech Processing', apis: ['OpenAI Whisper'], icon: Mic },
              { category: 'Economic Data', apis: ['FRED', 'BLS'], icon: BarChart3 },
              { category: 'Transportation', apis: ['BTS', 'FMCSA'], icon: Truck },
              { category: 'Document Management', apis: ['PDF Processing'], icon: FileText },
              { category: 'Mapping & Routing', apis: ['OpenStreetMap'], icon: MapPin },
              { category: 'Market Intelligence', apis: ['Multiple Sources'], icon: Globe }
            ].map((category, index) => (
  ...
  const renderAnalyticsReportingModule = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-purple-50 p-4 rounded-lg">
            <h4 className="font-semibold text-purple-800 mb-2">Key Performance Indicators</h4>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-center">
  ...
  const renderTroubleshootingModule = () => (
    <div className="space-y-6">
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                solution: 'Review system resources and optimize agent workloads',
                severity: 'High'
              },
              {
                issue: 'Voice Quality Issues',
                solution: 'Verify FreeSWITCH configuration and network bandwidth',
                severity: 'Medium'
              },
              {
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <h4 className="font-semibold text-blue-800 mb-2">Regular Maintenance Tasks</h4>
            <ul className="text-sm text-blue-700 space-y-1">
  ...
  const renderCertificationModule = () => (
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-gray-700">
            Complete your AI Flow certification to demonstrate mastery of the ultimate AI freight brokerage platform. 
            This certification validates your ability to operate, manage, and optimize the AI Flow system.
          </p>
          <div className="bg-gold-50 p-4 rounded-lg">
            <h4 className="font-semibold text-gold-800 mb-2">Certification Requirements</h4>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <span className="font-semibold text-blue-800">Modules Completed</span>
              <span className="text-blue-600 font-bold">{completedModules.length}/10</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-800">AI Flow Training</h1>
                <p className="text-sm text-gray-600">Master the Ultimate AI Freight Brokerage</p>
              </div>
            </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          <div className="font-medium text-sm text-gray-800">{module.title}</div>
