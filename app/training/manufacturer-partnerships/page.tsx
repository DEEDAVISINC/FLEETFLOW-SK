    ...
    <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px' }}>
          ...
          <div>
            <h1 style={{
              ...
              Manufacturer & Shipper Partnership Excellence
            </h1>
            <p style={{
              fontSize: '16px',
              ...
              Build strategic partnerships with manufacturers and logistics providers
            </p>
          </div>
        </div>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px' }}>
          <div style={{
            ...
            <div style={{ fontSize: '14px', fontWeight: '600', color: '#ffffff' }}>Construction</div>
            <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' }}>Materials & Equipment</div>
          </div>
          <div style={{
            background: 'rgba(59, 130, 246, 0.15)',
            borderRadius: '12px',
            ...
            <div style={{ fontSize: '14px', fontWeight: '600', color: '#ffffff' }}>Automotive</div>
            <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' }}>Parts & Assembly</div>
          </div>
          <div style={{
            background: 'rgba(59, 130, 246, 0.15)',
            borderRadius: '12px',
            ...
            <div style={{ fontSize: '24px', marginBottom: '8px' }}>🍕</div>
            <div style={{ fontSize: '14px', fontWeight: '600', color: '#ffffff' }}>Food & Beverage</div>
            <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' }}>Production & Distribution</div>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span>{completedModules.length * 36} minutes completed</span>
        </div>
      </div>
      ...
      {showCertificate && (
        <div style={{
          ...
          <p style={{ fontSize: '16px', color: '#ffffff', marginBottom: '24px' }}>
            You are now certified in Manufacturer & Shipper Partnership Excellence!
          </p>
          <button style={{
            background: '#ffffff',
            color: '#2563eb',
