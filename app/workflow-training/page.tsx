...
export default function WorkflowTrainingPage() {
  ...
  const [selectedRole, setSelectedRole] = useState<'dispatcher' | 'driver'>(
    'dispatcher'
  );
  ...
  const handleCertificationEarned = (certificate: any) => {
    ...
    localStorage.setItem(
      'fleetflow_workflow_certificates',
      JSON.stringify([...certificates, certificate])
    );
  };
  ...
  const dispatcherModules = [
    {
      ...
      level: 'Essential',
      description:
        'Master the complete FleetFlow workflow ecosystem and interconnected processes',
      sections: [
        {
          title: 'Dashboard Navigation',
          content:
            'Learn to navigate the main dashboard and access all key features efficiently',
          interactive: true,
          demo: '/dashboard-demo',
        },
        {
          ...
          content:
            'Understand how each module connects to create seamless operations',
          interactive: true,
          demo: '/workflow-demo',
        },
        {
          ...
          content:
            'Master keyboard shortcuts and quick action buttons for maximum efficiency',
          interactive: true,
          demo: '/shortcuts-demo',
        },
      ],
    },
    {
      ...
      level: 'Core',
      description:
        'Complete dispatcher workflow from load creation to delivery confirmation',
      sections: [
        {
          title: 'Load Creation & Assignment',
          content:
            'Create loads, assign drivers, and set up delivery schedules',
          interactive: true,
        ...
        },
        {
          ...
          content:
            'Monitor driver locations, delivery progress, and handle updates',
          interactive: true,
          demo: '/tracking-demo',
        },
        {
          ...
          content:
            'Manage driver communications, customer updates, and issue resolution',
          interactive: true,
        ...
        },
        {
          ...
          content:
            'Process PODs, photos, signatures, and complete delivery workflows',
          interactive: true,
          demo: '/delivery-demo',
        },
      ],
    },
    {
      ...
      level: 'Advanced',
      description:
        'Manage carrier relationships and freight brokerage operations',
      sections: [
        {
          title: 'Carrier Network Management',
          content:
            'Add carriers, manage relationships, and track performance metrics',
          interactive: true,
          demo: '/carrier-demo',
        },
        {
          ...
          content:
            'Post loads to load boards and match with available carriers',
          interactive: true,
          demo: '/matching-demo',
        },
        {
  ...
  const driverModules = [
    {
      ...
      level: 'Essential',
      description:
        'Master the FleetFlow mobile app for seamless on-the-road operations',
      sections: [
        {
          title: 'Mobile App Navigation',
          content:
            'Learn to navigate the mobile interface and access key features',
          interactive: true,
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            'Complete deliveries with photos, signatures, and POD submission',
          interactive: true,
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            'Upload licenses, medical certificates, and training records',
          interactive: true,
  ...
  const currentModules =
    selectedRole === 'dispatcher' ? dispatcherModules : driverModules;
  const selectedModuleData =
    currentModules.find((m) => m.id === selectedModule) || currentModules[0];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Master the complete FleetFlow workflow ecosystem for seamless
            operations
          </p>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontWeight: '600', color: '#374151' }}>
                  0/{selectedModuleData.sections.length}
                </div>
            ...
            {(selectedModule === 'dispatch-flow' ||
              selectedModule === 'broker-flow') && (
              <div
                style={{
                  marginTop: '24px',
                  textAlign: 'center',
              ...
              >
                <button
                  onClick={() =>
                    setShowQuiz(
                      selectedModule === 'dispatch-flow' ? 'dispatch' : 'broker'
                    )
                  }
                  style={{
