        ...
        async () => {
          const request: LinkTokenCreateRequest = {
            ...
            user_token_consent: {
              ...
              purpose:
                'Financial data for transportation business management and 7-year SOX compliance retention',
            },
          };
      ...
      ServiceErrorHandler.handleAsyncOperation(
        async () => {
          ...
          try {
            ...
            console.error(
              `Failed to delete Plaid data for user ${userId}:`,
              error
            );
            return false;
          }
    ...
    return ServiceErrorHandler.handleAsyncOperation(
      async () => {
        ...
        return {
          ...
          data_usage_purpose:
            'Financial data for transportation business management',
    ...
    return (
      ServiceErrorHandler.handleOperation(
        () => {
          ...
          const expiringSoon = Array.from(this.connectedUsers.values()).filter(
            (user) => user.data_retention_expiry <= thirtyDaysFromNow
          ).length;

          const complianceScore =
            totalUsers > 0
              ? ((totalUsers - expiringSoon) / totalUsers) * 100
              : 100;
