  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Carrier Information */}
        {(invitationData.carrier || invitationData.mc || invitationData.dot) && (
          <div
            style={{
            ...
            <div style={{ display: 'grid', gap: '8px', textAlign: 'left' }}>
              {invitationData.carrier && (
                <div style={{ color: 'white', fontSize: '1rem' }}>
                  <strong>Company:</strong> {decodeURIComponent(invitationData.carrier)}
                </div>
              )}
              {invitationData.mc && (
                <div style={{ color: 'white', fontSize: '1rem' }}>
              ...
              {invitationData.email && (
                <div style={{ color: 'white', fontSize: '1rem' }}>
                  <strong>Email:</strong> {decodeURIComponent(invitationData.email)}
                </div>
              )}
            </div>
          </div>
        ...
        >
          ...
          <div style={{ display: 'grid', gap: '12px' }}>
            <div style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span>🤝</span> Professional broker relationships and load assignments
            </div>
            <div style={{ color: 'rgba(255, 255, 255, 0.9)', fontSize: '1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
