    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '12px' }}>
        ...
        <span style={{
          ...
          {getStatusIcon(carrier.status)} {carrier.status.replace('_', ' ').toUpperCase()}
        </span>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '6px', fontSize: '0.7rem', marginBottom: '8px' }}>
        <div style={{ 
          background: carrier.documentsUploaded ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.2)',
          padding: '4px 6px',
          borderRadius: '4px',
        ...
        <div style={{ 
          background: carrier.insuranceVerified ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.2)',
          padding: '4px 6px',
          borderRadius: '4px',
        ...
        <div style={{ 
          background: carrier.agreementSigned ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.2)',
          padding: '4px 6px',
          borderRadius: '4px',
        ...
        <div style={{ 
          background: carrier.portalAccess ? 'rgba(16, 185, 129, 0.2)' : 'rgba(239, 68, 68, 0.2)',
          padding: '4px 6px',
          borderRadius: '4px',
...
export default function EnhancedCarrierPortal() {
  ...
  const [activeView, setActiveView] = useState<'dashboard' | 'onboarding' | 'analytics'>('dashboard');
  ...
  const [statusFilter, setStatusFilter] = useState<'all' | 'active' | 'inactive' | 'pending' | 'suspended' | 'under_review'>('all');
  ...
  const getStatusCounts = () => {
    const onboardingPipeline = carriers.filter(c => c.status === 'pending' || c.status === 'under_review').length;
    const averageCompletionTime = 12; // Mock: days to complete onboarding
    const complianceRate = Math.round((carriers.filter(c => c.documentsUploaded && c.insuranceVerified).length / carriers.length) * 100);
    const portalAdoption = Math.round((carriers.filter(c => c.portalAccess).length / carriers.filter(c => c.status === 'active').length) * 100);
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
              ...
              <div>
                ...
                <p style={{
                  ...
                  Comprehensive carrier management with workflow tracking & analytics
                </p>
                <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                ...
                const pipelineCarriers = [
                  {
                    ...
                    mcNumber: 'MC-789456',
                    currentStep: 2,
                    steps: ['FMCSA', 'Documents', 'Factoring', 'Agreements', 'Portal'],
                        ...
                        <div style={{
                          ...
                          <div>
                            ...
                            <p style={{
                              ...
                              {carrier.mcNumber} • Started {carrier.startDate} • Est. {carrier.estimatedCompletion}
                            </p>
                          </div>
                          <div style={{
                          ...
                          {carrier.steps.map((step, index) => (
                            <div
                              ...
                              style={{
                                ...
                                height: '6px',
                                borderRadius: '3px',
                                background: index <= carrier.currentStep 
                        ...
                        <div style={{
                          ...
                          {carrier.steps.map((step, index) => (
                            <span
                              key={index}
                              style={{
                                color: index <= carrier.currentStep 
                                  ? '#10b981' 
                                  : 'rgba(255, 255, 255, 0.6)',
                                fontWeight: index === carrier.currentStep ? '600' : '400'
                              }}
                            >
                              {step}
                            </span>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ display: 'grid', gap: '8px' }}>
                  {[
                    { carrier: 'Swift Logistics LLC', doc: 'Auto Liability Insurance', expires: '2024-12-30' },
                    { carrier: 'Prime Transport Inc', doc: 'Cargo Insurance', expires: '2025-01-05' },
                    { carrier: 'Elite Freight Solutions', doc: 'Certificate of Insurance', expires: '2025-01-10' }
                  ].map((alert, index) => (
                    <div
                      key={index}
                      style={{
                    ...
                    >
                      <span>{alert.carrier} - {alert.doc}</span>
                      <span style={{
                  ...
                  onMouseOut={(e) => {
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
                      ...
                      <div style={{
                        ...
                        fontSize: '12px',
                        fontWeight: '600',
                        background: carrier.status === 'active' ? 'rgba(74, 222, 128, 0.2)' :
                                   carrier.status === 'pending' ? 'rgba(251, 191, 36, 0.2)' :
                                   'rgba(239, 68, 68, 0.2)',
                        color: carrier.status === 'active' ? '#4ade80' :
                               carrier.status === 'pending' ? '#fbbf24' :
                               '#ef4444',
                        border: `1px solid ${carrier.status === 'active' ? '#4ade80' :
                                            carrier.status === 'pending' ? '#fbbf24' :
                                            '#ef4444'}`
                      }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <Link href="/onboarding/carrier-onboarding/new" style={{ textDecoration: 'none' }}>
                  <button style={{
                    background: 'linear-gradient(135deg, #10b981, #059669)',
                    color: 'white',
                    padding: '12px 16px',
                  ...
                  onMouseOut={(e) => {
                    ...
                    <div>
                      <div style={{ fontSize: '0.9rem', fontWeight: '600' }}>Start New Onboarding</div>
                      <div style={{ fontSize: '0.7rem', opacity: '0.8' }}>Begin carrier verification workflow</div>
                    </div>
                  </button>
                </Link>
                ...
                onMouseOut={(e) => {
                  ...
                  <span style={{ fontSize: '1.2rem' }}>📊</span>
                  <div>
                    <div style={{ fontSize: '0.9rem', fontWeight: '600' }}>FMCSA Bulk Lookup</div>
                    <div style={{ fontSize: '0.7rem', opacity: '0.8' }}>Verify multiple carriers</div>
                  </div>
                </button>
                ...
                onMouseOut={(e) => {
                  ...
                  <span style={{ fontSize: '1.2rem' }}>📄</span>
                  <div>
                    <div style={{ fontSize: '0.9rem', fontWeight: '600' }}>Document Review Queue</div>
                    <div style={{ fontSize: '0.7rem', opacity: '0.8' }}>Pending approvals ({statusCounts.underReview})</div>
                  </div>
                </button>
                ...
                onMouseOut={(e) => {
                  ...
                  <span style={{ fontSize: '1.2rem' }}>📝</span>
                  <div>
                    <div style={{ fontSize: '0.9rem', fontWeight: '600' }}>Generate Agreements</div>
                    <div style={{ fontSize: '0.7rem', opacity: '0.8' }}>Bulk contract creation</div>
                  </div>
                </button>
                ...
                onMouseOut={(e) => {
                  ...
                  <span style={{ fontSize: '1.2rem' }}>👤</span>
                  <div>
                    <div style={{ fontSize: '0.9rem', fontWeight: '600' }}>Portal Setup Assistant</div>
                    <div style={{ fontSize: '0.7rem', opacity: '0.8' }}>Configure driver access</div>
                  </div>
                </button>
                ...
                onMouseOut={(e) => {
                  ...
                  <span style={{ fontSize: '1.2rem' }}>🏦</span>
                  <div>
                    <div style={{ fontSize: '0.9rem', fontWeight: '600' }}>Factoring Integration</div>
                    <div style={{ fontSize: '0.7rem', opacity: '0.8' }}>Payment processing status</div>
                  </div>
                </button>
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '32px' }}>
                <div>
                  ...
                  <p style={{ color: 'rgba(255, 255, 255, 0.7)', margin: 0 }}>
                    Deep insights into your carrier onboarding and management performance
                  </p>
                </div>
                <div style={{ display: 'flex', gap: '12px' }}>
                  <button style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '48px', marginBottom: '16px' }}>📈</div>
                      <p style={{ color: 'white', margin: '0 0 8px 0' }}>Onboarding efficiency improving</p>
                      <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#10b981', margin: '0 0 4px 0' }}>+18%</p>
                      <p style={{ color: 'rgba(255, 255, 255, 0.7)', margin: 0, fontSize: '14px' }}>vs last quarter</p>
                    </div>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '48px', marginBottom: '16px' }}>🎯</div>
                      <p style={{ color: 'white', margin: '0 0 8px 0' }}>DOT compliance rate</p>
                      <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#3b82f6', margin: '0 0 4px 0' }}>94%</p>
                      <p style={{ color: 'rgba(255, 255, 255, 0.7)', margin: 0, fontSize: '14px' }}>Industry leading</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <h3 style={{ fontWeight: 'bold', fontSize: '16px', color: 'white', margin: '0 0 6px 0' }}>
                    Carriers Onboarded
                  </h3>
                  <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#10b981', margin: '0 0 4px 0' }}>{statusCounts.total}</p>
                  <p style={{ color: 'rgba(255, 255, 255, 0.7)', margin: 0, fontSize: '12px' }}>Total</p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#3b82f6', margin: '0 0 4px 0' }}>{statusCounts.averageCompletionTime}d</p>
                  <p style={{ color: 'rgba(255, 255, 255, 0.7)', margin: 0, fontSize: '12px' }}>To complete</p>
                </div>
                ...
                <div style={{
                  ...
                  <p style={{ fontSize: '32px', fontWeight: 'bold', color: '#8b5cf6', margin: '0 0 4px 0' }}>{statusCounts.portalAdoption}%</p>
                  <p style={{ color: 'rgba(255, 255, 255, 0.7)', margin: 0, fontSize: '12px' }}>Active users</p>
                </div>
              </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{
                  ...
                  DOT: {selectedCarrier.dotNumber} • MC: {selectedCarrier.mcNumber}
                </p>
              </div>
              <button
            ...
            <div style={{
              ...
              <div style={{
                ...
                {['FMCSA', 'Documents', 'Factoring', 'Agreements', 'Portal'].map((step, index) => {
                  const isCompleted = selectedCarrier.status === 'active' || Math.random() > 0.3;
            ...
            <div style={{
              ...
              <div style={{ display: 'grid', gap: '8px' }}>
                {[
                  { name: 'Certificate of Insurance', status: selectedCarrier.insuranceVerified, expires: '2025-06-15' },
                  { name: 'Auto Liability Insurance', status: selectedCarrier.insuranceVerified, expires: '2025-06-15' },
                  { name: 'Cargo Insurance', status: selectedCarrier.insuranceVerified, expires: '2025-06-15' },
                  { name: 'W-9 Tax Form', status: selectedCarrier.documentsUploaded, expires: 'N/A' },
                  { name: 'MC Authority Letter', status: selectedCarrier.documentsUploaded, expires: 'N/A' }
                ].map((doc, index) => (
                  <div
                    key={index}
                    style={{
                  ...
                  >
                    ...
                    <span style={{
                      ...
                      {doc.expires !== 'N/A' ? `Expires: ${doc.expires}` : doc.expires}
                    </span>
                  </div>
                ))}
              </div>
