...
import DispatcherPortalGettingStarted from '../components/DispatcherPortalGettingStarted';
  ...
  return (
    <div>
      ...
      >
        ...
        <DispatcherPortalGettingStarted
        ...
        <div>
          ...
          >
            ...
            {selectedTab === 'ai-optimization' && (
              <div id='tab-ai-optimization' style={{ marginTop: '25px' }}>
