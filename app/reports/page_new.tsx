            ...
            {reportTypes.map((report) => (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  ...
                  <div>
                    <div style={{ fontWeight: '600', fontSize: '16px' }}>{report.label}</div>
          ...
          {kpis.map((kpi, index) => (
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '8px' }}>
                <div style={{ fontSize: '14px', color: '#6b7280', fontWeight: '500' }}>{kpi.label}</div>
                <span style={{
                  fontSize: '12px',
                  fontWeight: '600',
                  color: '#10b981',
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{
                    ...
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#1f2937' }}>Total Distance</th>
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#1f2937' }}>Fuel Used</th>
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#1f2937' }}>Efficiency</th>
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#1f2937' }}>Uptime</th>
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#1f2937' }}>Maintenance Cost</th>
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: '600', color: '#1f2937' }}>Performance Score</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    >
                      <td style={{ padding: '16px', fontWeight: '600', color: '#3b82f6' }}>{row.vehicle}</td>
                      <td style={{ padding: '16px', color: '#1f2937' }}>{row.distance}</td>
                      <td style={{ padding: '16px', color: '#1f2937' }}>{row.fuel}</td>
                      <td style={{ padding: '16px', color: '#1f2937' }}>{row.efficiency}</td>
                      <td style={{ padding: '16px', color: '#1f2937' }}>{row.uptime}</td>
                      <td style={{ padding: '16px', color: '#1f2937' }}>{row.maintenance}</td>
                      <td style={{ padding: '16px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          <span style={{ fontWeight: '600', color: '#1f2937' }}>{row.score}</span>
                          <div style={{ 
                            width: '40px', 
                            height: '6px', 
