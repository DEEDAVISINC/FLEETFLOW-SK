            ...
            {[
              {
                ...
                bgColor: 'linear-gradient(135deg, rgba(20, 184, 166, 0.1), rgba(20, 184, 166, 0.02))',
              },
              {
                icon: '💰',
                ...
                bgColor: 'linear-gradient(135deg, rgba(59, 130, 246, 0.1), rgba(59, 130, 246, 0.02))',
              },
              {
                icon: '🌐',
                ...
                bgColor: 'linear-gradient(135deg, rgba(139, 92, 246, 0.1), rgba(139, 92, 246, 0.02))',
              },
              {
                icon: '🛡️',
                ...
                bgColor: 'linear-gradient(135deg, rgba(239, 68, 68, 0.1), rgba(239, 68, 68, 0.02))',
              },
              {
                icon: '📊',
                ...
                bgColor: 'linear-gradient(135deg, rgba(6, 182, 212, 0.1), rgba(6, 182, 212, 0.02))',
              },
              {
                icon: '🚀',
                ...
                bgColor: 'linear-gradient(135deg, rgba(245, 158, 11, 0.1), rgba(245, 158, 11, 0.02))',
              },
            ].map((feature, index) => (
              <div
                key={index}
