      ...
      >
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          >
            ...
            >
              Carrier networking platform with AI-powered operations, instant settlements, and premium load access.
            </p>
            ...
            >
              {[
                { label: 'Carriers', value: '15K+', color: '#14b8a6' },
                { label: 'Volume', value: '$500M+', color: '#3b82f6' },
                { label: 'Satisfaction', value: '98%', color: '#10b981' },
              ].map((stat, idx) => (
          ...
          >
            {[
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, rgba(255, 255, 255, 0.1), rgba(20, 184, 166, 0.05))',
                  backdropFilter: 'blur(15px)',
                  borderRadius: '16px',
                  padding: '25px',
      ...
      <section id='contact-section' style={{ padding: '20px 20px' }}>
        ...
        >
          ...
          >
            ...
            >
              Get started with FleetFlow. Our team is ready to help onboard your fleet.
            </p>
