      ...
      >
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          >
            ...
            >
              Find loads, manage your fleet, and get paid fast. Everything you need to run your trucking business.
            </p>
            ...
            >
              {[
                { label: 'Active Carriers', value: '12K+', color: '#14b8a6' },
                { label: 'Monthly Revenue', value: '$200M+', color: '#3b82f6' },
                { label: 'User Rating', value: '4.8/5', color: '#10b981' },
              ].map((stat, idx) => (
