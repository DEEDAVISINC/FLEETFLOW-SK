...
} from '../components/CertificateGenerator';
...
export default function CertificatePreview() {
  ...
  const handleGenerateSampleCertificate = async () => {
    ...
    try {
      const pdfBlob = await CertificateGenerator.generateCertificatePDF(
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: '1.1rem', color: '#6b7280', lineHeight: '1.6' }}>
          Preview the professional certificate design that users will receive
          upon completing training modules.
        </p>
      </div>
        ...
        >
              ...
              >
                <div style={{ textAlign: 'left' }}>
                  ...
                  <div style={{ fontWeight: 'bold', color: '#1f2937' }}>
                    {sampleCertificateData.dateEarned}
                  </div>
                </div>
                ...
                <div style={{ textAlign: 'right' }}>
                  ...
                  <div style={{ fontWeight: 'bold', color: '#1f2937' }}>
                    {sampleCertificateData.validUntil}
                  </div>
                </div>
              </div>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            >
              {isGenerating
                ? '⏳ Generating PDF...'
                : '📄 Generate Sample Certificate PDF'}
            </button>
        ...
        >
          ...
          <div style={{ lineHeight: '1.8', fontSize: '0.95rem' }}>
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <div style={{ color: '#6b7280' }}>
                {sampleCertificateData.recipientRole}
              </div>
            </div>
          ...
          >
            ...
            >
              The blue circle with truck icon is a placeholder.
              <br />
