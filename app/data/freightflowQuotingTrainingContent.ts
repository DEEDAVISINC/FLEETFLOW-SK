        ...
        workflowSteps: [
          {
            ...
            description:
              'Choose customer to determine pricing tiers and discounts',
            details: {
              customerTiers: [
                {
                  tier: '🥈 Silver',
          ...
          },
          {
            ...
            description:
              'Click "🎯 Select Quote" on preferred option to create official quote',
            details: {
              selectionProcess: [
      ...
      content: {
        engines: [
          ...
          },
          {
            ...
            customerTiers: [
              {
                tier: 'Silver (4% discount)',
                description: 'Standard volume customers',
              },
              {
                tier: 'Gold (6% discount)',
                description: 'High-volume preferred customers',
              },
              {
                tier: 'Platinum (8% discount)',
                description: 'Premium enterprise customers',
              },
            ],
            discountApplication: [
    ...
    sampleQuestions: [
      {
        ...
        question:
          'Which combination of settings would trigger all four pricing engines?',
        options: [
        ...
        correctAnswer: 1,
        explanation:
          'Emergency urgency triggers emergency pricing, Warehousing equipment triggers warehousing services, Platinum customer gets volume discount, and spot rate is always active.',
      },
      {
        id: 2,
        type: 'multiple-choice',
        question:
          'A Platinum customer (8% discount) has a calculated rate of $2,500. What is the final discounted rate?',
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          'Unified quotes automatically sync to both the quoting system and broker dashboard.',
      },
    ],
    practicalScenarios: [
      {
        id: 1,
        scenario:
          'Target Logistics (Gold - 6% discount), 15,000 lbs, Los Angeles to Phoenix, Standard urgency, Dry Van',
        task: 'Calculate expected rate and identify which engines apply',
        solution:
          'Engines: Spot Rate (always) + Volume Discount (6%). Base calculation with market adjustment. 6% Gold tier discount applied. No emergency or warehousing charges.',
      },
      {
        id: 2,
        scenario:
          'Amazon Fulfillment (Platinum - 8% discount), 30,000 lbs, Chicago to Miami, Critical urgency, Expedited equipment',
        task: 'Identify all applicable engines and explain pricing strategy',
        solution:
          'All four engines apply. Emergency pricing (25% premium), Spot rate optimization (5% adjustment), Volume discount (8% Platinum). Premium justified by critical timing.',
      },
    ],
  },
  certification: {
