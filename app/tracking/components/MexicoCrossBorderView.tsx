...
interface Shipment {
  ...
  crossBorderInfo?: {
    ...
    crossingStatus: 'pending' | 'in-process' | 'cleared' | 'delayed' | 'rejected';
...
export default function MexicoCrossBorderView({ shipments }: MexicoCrossBorderViewProps) {
  const [activeTab, setActiveTab] = useState('overview');
  const [crossBorderData, setCrossBorderData] = useState<MexicoCrossBorderData | null>(null);
    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '18px', fontWeight: '600' }}>Loading Mexico Cross-Border Intelligence...</div>
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '12px', opacity: 0.8 }}>ACE Compliance</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#fbbf24' }}>
                  {crossBorderData.complianceStats.saaiCompliance}%
                </div>
                <div style={{ fontSize: '12px', opacity: 0.8 }}>SAAI-M Compliance</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#f87171' }}>
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '12px', opacity: 0.8 }}>Inspection Rate</div>
              </div>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '16px' }}>
                <div>
                  ...
                  <div style={{ fontSize: '12px', opacity: 0.8 }}>Wait Time</div>
                </div>
                <div>
                  <div style={{ fontSize: '20px', fontWeight: 'bold', color: '#34d399' }}>
                    {crossing.throughput.toLocaleString()}
                  </div>
                  <div style={{ fontSize: '12px', opacity: 0.8 }}>Daily Throughput</div>
                </div>
              </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
          <div style={{
            ...
            <div style={{ marginBottom: '16px' }}>
              <div style={{ fontSize: '14px', marginBottom: '8px' }}>Requirements:</div>
              <ul style={{ fontSize: '12px', opacity: 0.9, paddingLeft: '16px' }}>
          ...
          <div style={{ display: 'grid', gap: '16px' }}>
            {crossBorderShipments.slice(0, 5).map((shipment, index) => (
              ...
              >
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '12px', opacity: 0.8 }}>Manifest Type</div>
                  <div style={{ fontWeight: '600' }}>
                    {shipment.crossBorderInfo?.manifestType || 'ACE'}
                  </div>
                </div>
                <div style={{ textAlign: 'center' }}>
                  <div style={{ fontSize: '12px', opacity: 0.8 }}>Status</div>
                  <div style={{
                    background: shipment.crossBorderInfo?.crossingStatus === 'cleared' ? '#10b981' : '#f59e0b',
                    color: 'white',
                    padding: '2px 8px',
                    borderRadius: '4px',
                    fontSize: '12px',
