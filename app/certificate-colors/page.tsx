    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Preview how certificates look with different training module color
            schemes
          </p>
                  ...
                  style={{
                    ...
                    border:
                      selectedModule === module.id
                        ? `3px solid ${moduleColors.primary}`
                        : '2px solid #e5e7eb',
                    borderRadius: '12px',
                    background:
                      selectedModule === module.id
                    ...
                    fontSize: '14px',
                    fontWeight:
                      selectedModule === module.id ? 'bold' : 'normal',
                    cursor: 'pointer',
                    transition: 'all 0.3s ease',
                    transform:
                      selectedModule === module.id ? 'scale(1.05)' : 'scale(1)',
                    boxShadow:
                      selectedModule === module.id
                        ? `0 4px 12px ${moduleColors.light}`
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                ✨ This certificate uses the {selectedModuleData?.title} color
                scheme
              </p>
              <p
                style={{
              ...
              >
                The colors automatically match the training module's branding
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Certificates automatically detect the training module and apply
                the corresponding color scheme from the training module
                definitions.
              </p>
            </div>
            ...
            >
              ...
              >
                Each certificate maintains visual consistency with its training
                module's quick link colors and overall branding theme.
              </p>
            </div>
            ...
            >
              ...
              >
                Gradient backgrounds, elegant typography, and module-specific
                accents create professional, personalized certificates.
              </p>
            </div>
          </div>
        </div>
