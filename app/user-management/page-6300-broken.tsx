...
import EnhancedUserRegistration from '../components/EnhancedUserRegistration';
...
const mockUsers = [
  ...
  // Sample Freight Brokerage Business (FBB) entity
  {
    ...
    businessInfo: {
      companyId: 'FBB-987654', // Company identifier (sample format like FBB-XXXXXX)
      companyName: 'Sample Freight Brokerage LLC', // Sample company name
      businessAddress: '123 Business Park Dr, Atlanta, GA 30309',
      mcNumber: 'MC-987654', // Sample MC number
      dotNumber: 'DOT-456789', // Sample DOT number
      ...
      territories: ['Southeast', 'Midwest', 'Texas'], // Sample territories
      specializations: ['Dry Van', 'Refrigerated', 'Flatbed'], // Sample specializations
    },
    ...
    permissions: {
      // Full brokerage management permissions
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Business Entity Information - Only for FBB users - MOVED BEFORE ONBOARDING */}
            {currentUser.departmentCode === 'FBB' &&
                ...
                <>
                    ...
                    >
                      ...
                      >
                        <div>
                          ...
                          <div style={{ marginTop: '8px' }}>
                            ...
                            >
                              {currentUser.businessInfo.companyId || 'Not assigned'}
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          >
                            {currentUser.businessInfo.businessPhone}
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            {currentUser.businessInfo.dotNumber || 'Not provided'}
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          >
                            {currentUser.businessInfo.businessEmail}
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    >
                      <div>
                        ...
                        >
                          {currentUser.businessInfo.incorporationDate
                            ? new Date(
                                currentUser.businessInfo.incorporationDate
                              ).toLocaleDateString()
                            : 'Not provided'}
                      ...
                      <div>
                        ...
                        >
                          {currentUser.businessInfo.taxId || 'Not provided'}
                        </div>
                      </div>
                    </div>
                  </div>

                  {/* Agent Management - Child Agents */}
                  <div
                    style={{
                      background: 'rgba(0, 0, 0, 0.2)',
                      borderRadius: '12px',
                  ...
                  >
                    ...
                    <div>
                      ...
                      {(() => {
                        const childAgentCount = mockUsers.filter(
                          (user) =>
                            user.departmentCode === 'BB' &&
                            user.parentCompanyId === currentUser.id
                        ).length;
                        ...
                        return (
                          ...
                          >
                            📊 Total Active Agents: {childAgentCount}
                          </div>
                        );
                      })()}
                    </div>
            ...
            {/* Training Management & Workflow Status */}
            <div
              style={{
            ...
            >
              ...
              >
                🎓 FleetFlow University℠ Training Access Management
              </h4>
              ...
              {userWorkflowData[currentUser.id] ? (
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {userWorkflowData[currentUser.id].trainingProgress
                          .length > 0
                          ? Math.round(
                              userWorkflowData[
                                currentUser.id
                              ].trainingProgress.reduce(
                  ...
                  {userWorkflowData[currentUser.id].trainingAssignments.length >
                    0 && (
                    <div
                      style={{
                        marginBottom: '16px',
                    ...
                    >
                      ...
                      >
                        {userWorkflowData[currentUser.id].trainingAssignments
                          .slice(0, 3)
                          .map((assignment) => (
                            <div
                ...
                >
                  ...
                  >
                    Grant FleetFlow University℠ Access
                  </div>
                  <div
                    style={{
                      color: 'rgba(255, 255, 255, 0.7)',
                  ...
                  >
                    This user needs access to FleetFlow University℠ training
                  ...
                  >
                    🎓 Grant University Access
                        ...
                        {/* Custom Training Assignment - Coming Soon */}
