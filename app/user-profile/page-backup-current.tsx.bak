...
export default function UserProfile() {
  ...
  useEffect(() => {
    ...
    // Load ICA onboarding for this user
    ...
    if (userWorkflow) {
      ...
      // In real app, this would only happen when user is created from user-management
    }
  ...
  return (
    ...
    >
      ...
      >
        {/* Header - exactly from user-management but for single user */}
        <div
          style={{
        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 2 }}>
            ...
            >
              Personal profile, permissions, and onboarding progress
            </p>
          </div>
        </div>
        ...
        >
                ...
                style={{
                  background:
                    currentUser.status === 'active'
                      ...
                      : 'rgba(239, 68, 68, 0.2)',
                  color:
                    currentUser.status === 'active' ? '#10b981' : '#ef4444',
                  padding: '12px 24px',
                  borderRadius: '20px',
                  fontSize: '14px',
                  fontWeight: '600',
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    {currentUser?.emergencyContact?.relation || 'Not specified'}
                  </div>
                </div>
              </div>
          ...
          {(currentUser.departmentCode !== 'DM' ? icaOnboarding : workflowData?.carrierOnboardingStatus) && (
            <div
              style={{
                padding: '32px',
                borderBottom: '1px solid rgba(255, 255, 255, 0.1)',
            ...
            >
              ...
              >
                ...
                >
                  Progress: {currentUser.departmentCode === 'DM'
              ...
              >
                <div
                  style={{
                    ...
                    height: '100%',
                    width: `${currentUser.departmentCode === 'DM'
                      ? workflowData?.carrierOnboardingStatus?.overallProgress || 0
              ...
              >
                {currentUser.departmentCode === 'DM' ? (
                  ...
                  [
                    { id: 'fmcsa', title: 'FMCSA Verification', icon: '🚛', description: 'Verify carrier credentials and safety ratings' },
                    { id: 'limits', title: 'Travel Limits', icon: '🗺️', description: 'Set operational boundaries and service areas' },
                    { id: 'documents', title: 'Documents', icon: '📋', description: 'Upload insurance, permits, and certifications' },
                    { id: 'factoring', title: 'Factoring', icon: '💰', description: 'Configure payment and factoring preferences' },
                    { id: 'agreements', title: 'Agreements', icon: '📝', description: 'Review and sign carrier agreements' },
                    { id: 'portal', title: 'Portal Setup', icon: '👤', description: 'Complete driver portal configuration' }
                  ].map((step, index) => {
                    const isCompleted = (workflowData?.carrierOnboardingStatus?.completedSteps || []).includes(step.title);
                    const isCurrent = (workflowData?.carrierOnboardingStatus?.currentStep || 1) === index + 1;
                    return (
                      <div
                        key={step.id}
                        style={{
