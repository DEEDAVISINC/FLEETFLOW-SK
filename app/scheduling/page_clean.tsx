            ...
            {viewMode === 'list' && (
              <div className="bg-white rounded-lg shadow-sm border"">
                <div className="p-6 border-b"">
                  ...
                  <p className="text-sm text-gray-600"">Manage and monitor all schedules</p>
                </div>
                    ...
                    schedules.map((schedule) => (
                      <div key={schedule.id} className="p-6 hover:bg-gray-50"">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600"">
                          ...
                          <div>
                            <p><span className="font-medium"">Route:</span> {schedule.origin} → {schedule.destination}</p>
                            <p><span className="font-medium"">Distance:</span> {schedule.estimatedDistance} miles</p>
                          </div>
                        </div>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6"">
                <div className="text-center py-12"">
                  ...
                  <p className="text-gray-600 mb-4"">
                    Weekly schedule view with resource allocation coming soon
                  </p>
                  <button
                    onClick={() => setViewMode('list')}
                    className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700""
            ...
            {viewMode === 'calendar' && (
              <div className="bg-white rounded-lg shadow-sm border p-6"">
                <div className="text-center py-12"">
                  ...
                  <p className="text-gray-600 mb-4"">
                    Full calendar view coming soon with drag-and-drop scheduling
                  </p>
                  <button
                    onClick={() => setViewMode('list')}
                    className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700""
