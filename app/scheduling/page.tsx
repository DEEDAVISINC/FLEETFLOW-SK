...
const schedulingService = {
  ...
  getVehicleAvailability: () => [
    ...
    { vehicleId: 'VEH002', name: 'Truck 002', status: 'In Use' as const, currentDriver: 'Sarah Williams' },
...
export default function SchedulingDashboard() {
  ...
  const getStatusColor = (status: Schedule['status']) => {
    switch (status) {
      ...
      case 'Completed':
        return { bg: 'rgba(16, 185, 129, 0.2)', text: '#10b981', border: 'rgba(16, 185, 129, 0.3)' };
      case 'Cancelled':
        return { bg: 'rgba(239, 68, 68, 0.2)', text: '#ef4444', border: 'rgba(239, 68, 68, 0.3)' };
      case 'Delayed':
        return { bg: 'rgba(249, 115, 22, 0.2)', text: '#f97316', border: 'rgba(249, 115, 22, 0.3)' };
      default:
        return { bg: 'rgba(107, 114, 128, 0.2)', text: '#6b7280', border: 'rgba(107, 114, 128, 0.3)' };
    }
  };
  ...
  const getFMCSAStatusColor = (status: DriverAvailability['fmcsaStatus']) => {
    switch (status) {
      case 'Compliant':
        return { bg: 'rgba(16, 185, 129, 0.2)', text: '#10b981', icon: <CheckCircle size={12} /> };
      case 'Warning':
        return { bg: 'rgba(245, 158, 11, 0.2)', text: '#f59e0b', icon: <AlertTriangle size={12} /> };
      case 'Violation':
        return { bg: 'rgba(239, 68, 68, 0.2)', text: '#ef4444', icon: <XCircle size={12} /> };
      default:
        return { bg: 'rgba(107, 114, 128, 0.2)', text: '#6b7280', icon: <AlertTriangle size={12} /> };
    }
  };

  const checkFMCSACompliance = (driver: DriverAvailability, newHours: number) => {
    ...
    return {
      compliant: totalDriving <= FMCSA_RULES.maxDrivingHours && 
                 totalOnDuty <= FMCSA_RULES.maxOnDutyHours &&
                 driver.hoursOfService.weeklyDriving + newHours <= FMCSA_RULES.maxWeeklyDriving,
      violations: {
        dailyDriving: totalDriving > FMCSA_RULES.maxDrivingHours,
        dailyOnDuty: totalOnDuty > FMCSA_RULES.maxOnDutyHours,
        weeklyDriving: driver.hoursOfService.weeklyDriving + newHours > FMCSA_RULES.maxWeeklyDriving
      }
    };
  };
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: '18px', fontWeight: '600' }}>Loading scheduling system...</span>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ 
      ...
      {/* Back Button */}
      <div style={{ padding: '0 0 24px 0', maxWidth: '1600px', margin: '0 auto' }}>
      ...
      <div style={{ maxWidth: '1600px', margin: '0 auto' }}>
        ...
        {statistics && (
          ...
          <div style={{
            ...
            {[
                { icon: '📅', label: 'Total', value: statistics.totalSchedules, color: '#3b82f6', trend: '+12%' },
                { icon: '⏳', label: 'In Progress', value: statistics.inProgressCount, color: '#f59e0b', trend: '+5%' },
                { icon: '✅', label: 'Completed', value: statistics.completedCount, color: '#10b981', trend: '+18%' },
                { icon: '📊', label: 'Utilization', value: `${statistics.utilizationRate}%`, color: '#8b5cf6', trend: '+3%' },
                { icon: '🛡️', label: 'FMCSA Compliant', value: `${statistics.complianceRate}%`, color: '#06b6d4', trend: '+2%' },
                { icon: '⚠️', label: 'Violations', value: statistics.fmcsaViolations, color: '#ef4444', trend: '-1' },
                { icon: '👥', label: 'Drivers Available', value: statistics.driversAvailable, color: '#10b981', trend: '+2' },
                { icon: '🚛', label: 'Vehicles Available', value: statistics.vehiclesAvailable, color: '#3b82f6', trend: '+1' }
            ].map((stat, index) => (
              <div key={index} style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '300px 1fr', gap: '20px' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '9px', opacity: 0.9 }}>Total Schedules</div>
                </div>
                <div style={{
                  background: 'linear-gradient(135deg, #10b981, #059669)',
                  color: 'white',
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '12px', fontWeight: '600' }}>
                    ${schedules.reduce((sum, s) => sum + (s.estimatedHours ? s.estimatedHours * 50 : 0), 0).toFixed(0)}
                  </div>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '9px', opacity: 0.9 }}>Violations</div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '11px', fontWeight: '600', color: '#374151' }}>
                    ...
                    {drivers.filter(d => d.fmcsaStatus === 'Compliant').length}/{drivers.length} Compliant
                      </span>
                    </div>
                <div style={{
                  display: 'grid',
              ...
              <div style={{ marginBottom: '12px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                  {drivers.map((driver) => {
                    ...
                    const drivingProgress = (driver.hoursOfService.drivingHours / FMCSA_RULES.maxDrivingHours) * 100;
                    const onDutyProgress = (driver.hoursOfService.onDutyHours / FMCSA_RULES.maxOnDutyHours) * 100;
                      ...
                      justifyContent: 'space-between',
                        ...
                        <div style={{ marginBottom: '3px' }}>
                          <div style={{
                            ...
                            <span>Driving: {driver.hoursOfService.drivingHours}h</span>
                          ...
                          <div style={{
                            ...
                            <div style={{
                              ...
                              height: '100%',
                              background: drivingProgress > 90 ? '#ef4444' : drivingProgress > 75 ? '#f59e0b' : '#10b981',
          ...
          <div>
            <div style={{
                            ...
                            <span>On-Duty: {driver.hoursOfService.onDutyHours}h</span>
              ...
              <div style={{
                            ...
                            <div style={{
                              ...
                              height: '100%',
                              background: onDutyProgress > 90 ? '#ef4444' : onDutyProgress > 75 ? '#f59e0b' : '#3b82f6',
                              transition: 'width 0.3s ease'
                            }} />
                          </div>
                        </div>
                  ...
                  color: '#6b7280',
                          ...
                          <span>Weekly: {driver.hoursOfService.weeklyDriving}h driving</span>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div style={{
                            ...
                            <span style={{ display: 'flex', alignItems: 'center', gap: '2px' }}>
                              ...
                              FMCSA {schedule.fmcsaCompliant ? 'Compliant' : 'Violation'}
                            </span>
                          </div>
                        ...
                        <div style={{ textAlign: 'center' }}>
                          <div style={{ fontSize: '12px', fontWeight: '600', color: '#10b981' }}>
                            ${schedule.estimatedHours ? (schedule.estimatedHours * 50).toFixed(0) : 'N/A'}
                          </div>
                          <div style={{ fontSize: '10px', color: '#6b7280' }}>
                            Cost
                          </div>
                        ...
                        <div style={{ display: 'flex', gap: '4px' }}>
                          <button style={{
                            ...
                            >
                            <Eye style={{ width: '12px', height: '12px', color: '#6b7280' }} />
                            </button>
                          <button style={{
                            padding: '4px',
                            background: '#f3f4f6',
                            ...
                            >
                            <Edit style={{ width: '12px', height: '12px', color: '#6b7280' }} />
                            </button>
                          </div>
                        </div>
                    </div>
              ...
              <div style={{
                ...
                <div style={{ 
                  ...
                  fontSize: '12px'
                    ...
                    {/* Header */}
                    <div style={{ background: '#f1f5f9', padding: '8px', fontWeight: '600', textAlign: 'center' }}>Driver</div>
                    {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map(day => (
                      <div key={day} style={{ background: '#f1f5f9', padding: '8px', fontWeight: '600', textAlign: 'center' }}>
                        {day}
                          </div>
                    ))}
                          ...
                          return (
                            <div key={i} style={{ 
                              ...
                              {daySchedules.map(schedule => (
                                <div key={schedule.id} style={{
                                  background: schedule.fmcsaCompliant ? '#dcfce7' : '#fee2e2',
        ...
        >
          ...
          >
            ...
            <div style={{
              ...
              >
                <XCircle style={{ width: '20px', height: '20px', color: '#6b7280' }} />
              </button>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
              ...
              <div>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      ...
                      <strong style={{ fontSize: '14px', color: '#111827' }}>Origin:</strong>
                    </div>
                    <p style={{ fontSize: '14px', color: '#374151', margin: 0, paddingLeft: '16px' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      ...
                      <strong style={{ fontSize: '14px', color: '#111827' }}>Destination:</strong>
                    </div>
                    <p style={{ fontSize: '14px', color: '#374151', margin: 0, paddingLeft: '16px' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      ...
                      <strong style={{ fontSize: '14px', color: '#111827' }}>Schedule:</strong>
                    </div>
                    <p style={{ fontSize: '14px', color: '#374151', margin: 0, paddingLeft: '24px' }}>
                      {selectedSchedule.startDate} • {selectedSchedule.startTime} - {selectedSchedule.endTime}
                    </p>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      ...
                      <strong style={{ fontSize: '14px', color: '#111827' }}>Assigned Driver:</strong>
                    </div>
                    <p style={{ fontSize: '14px', color: '#374151', margin: 0, paddingLeft: '24px' }}>
              ...
              {/* Right Column - FMCSA & Financial */}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  {/* FMCSA Status */}
                  <div style={{
                    background: selectedSchedule.fmcsaCompliant ? '#f0fdf4' : '#fef2f2',
                    padding: '16px',
                    borderRadius: '8px',
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                      ...
                      <strong style={{ 
                        fontSize: '14px', 
                        color: selectedSchedule.fmcsaCompliant ? '#10b981' : '#ef4444' 
                      }}>
                        FMCSA {selectedSchedule.fmcsaCompliant ? 'Compliant' : 'Violation'}
                      </strong>
                  </div>
                  ...
                  <div>
                        ...
                        <span style={{ 
                          color: selectedSchedule.hoursOfService.drivingHours > 11 ? '#ef4444' : '#10b981',
                          fontWeight: '600',
                          marginLeft: '8px'
                        }}>
                  ...
                  <div>
                        ...
                        <span style={{ 
                          color: selectedSchedule.hoursOfService.onDutyHours > 14 ? '#ef4444' : '#10b981',
                          fontWeight: '600',
                          marginLeft: '8px'
                        }}>
                  ...
                  <div>
                        ...
                        <span style={{ 
                          color: selectedSchedule.hoursOfService.restHours < 10 ? '#ef4444' : '#10b981',
                          fontWeight: '600',
                          marginLeft: '8px'
                        }}>
                  ...
                  <div>
                        <span style={{ color: '#6b7280' }}>Weekly Driving:</span>
                        <span style={{ 
                          color: selectedSchedule.hoursOfService.weeklyDriving > 60 ? '#ef4444' : '#10b981',
                          fontWeight: '600',
                          marginLeft: '8px'
                        }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                      ...
                      <strong style={{ fontSize: '14px', color: '#111827' }}>Financial Details</strong>
                    </div>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', fontSize: '12px' }}>
                  <div>
                        <span style={{ color: '#6b7280' }}>Total Load Revenue:</span>
                        <span style={{ color: '#10b981', fontWeight: '600', marginLeft: '8px' }}>
                          ${(() => {
                            ...
                            const totalRevenue = schedules.reduce((sum, schedule) => {
                              ...
                              const rateMatch = schedule.title.match(/\$(\d+)/);
                              const rate = rateMatch ? parseInt(rateMatch[1]) : 2850; // Default rate
                              return sum + rate;
                            }, 0);
                  ...
                  <div>
                        <span style={{ color: '#6b7280' }}>Avg Rate per Hour:</span>
                        <span style={{ color: '#3b82f6', fontWeight: '600', marginLeft: '8px' }}>
                          ${(() => {
                            ...
                            const totalRevenue = schedules.reduce((sum, schedule) => {
                              const rateMatch = schedule.title.match(/\$(\d+)/);
                              const rate = rateMatch ? parseInt(rateMatch[1]) : 2850;
                              return sum + rate;
                            }, 0);
                            return totalHours > 0 ? (totalRevenue / totalHours).toFixed(0) : 'N/A';
                          })()}
                        </span>
                  </div>
                  <div>
                        <span style={{ color: '#6b7280' }}>Schedule Revenue:</span>
                        <span style={{ color: '#f59e0b', fontWeight: '600', marginLeft: '8px' }}>
                          ${(() => {
                            const rateMatch = selectedSchedule.title.match(/\$(\d+)/);
                            const rate = rateMatch ? parseInt(rateMatch[1]) : 2850;
                  ...
                  <div>
                        <span style={{ color: '#6b7280' }}>Hours Scheduled:</span>
                        <span style={{ color: '#8b5cf6', fontWeight: '600', marginLeft: '8px' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                      <div style={{ fontSize: '16px' }}>📝</div>
                      <strong style={{ fontSize: '14px', color: '#111827' }}>Reason:</strong>
                    </div>
                    <p style={{ fontSize: '14px', color: '#374151', margin: 0, paddingLeft: '24px' }}>
            ...
            {/* Action Buttons */}
              ...
              <button style={{
               ...
               onClick={() => {
                 ...
                 sessionStorage.setItem('trackingInfo', JSON.stringify({
                   driverId,
                   driverName,
                   scheduleId,
