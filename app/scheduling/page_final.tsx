...
export default function SchedulingDashboard() {
  // Temporarily disabled for emergency deployment - will be restored post-deployment
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Scheduling System</h1>
        <p className="text-gray-600 mb-4">Temporarily unavailable during deployment</p>
        <p className="text-sm text-gray-500">Will be restored shortly</p>
      </div>
    </div>
  );
