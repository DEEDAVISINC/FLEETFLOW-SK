...
export default function AgentPortal() {
  ...
  const [aiFlowOptIn, setAiFlowOptIn] = useState(false);
      ...
      {activeTab === 'prospecting' && (
        ...
        >
          ...
          >
            ...
            >
              🎯 Shipper & Manufacturer Prospecting
            </h2>
            <div style={{ display: 'flex', gap: '10px' }}>
              <button
                onClick={() => setAiFlowOptIn(!aiFlowOptIn)}
                style={{
                  background: aiFlowOptIn
              ...
              >
                {aiFlowOptIn ? '✅ AI Flow Enabled' : '🤖 Enable AI Flow'}
              </button>
              <Link
                href='/dialer'
                style={{
              ...
              >
                {showShipperForm ? '✖️ Close' : '➕ Add Shipper'}
              </button>
            </div>
          </div>
          ...
          {showShipperForm ? (
            <AddShipperForm
              onClose={() => setShowShipperForm(false)}
              onSubmit={() => {
            ...
            <div>
              ...
              >
                ...
                >
                  You have access to AI lead generation, smart prospect scoring, and automated outreach campaigns.
                </p>
              </div>
              <WorkingCRMDashboard />
            </div>
            ...
            >
              ...
              >
                ...
                >
                  Target manufacturers needing freight services for raw materials and finished goods.
                </p>
                <button
                  style={{
                    background: 'linear-gradient(135deg, #3b82f6, #1d4ed8)',
              ...
              >
                ...
                >
                  Connect with retailers needing regular transportation for inventory management.
                </p>
                <button
                  style={{
                    background: 'linear-gradient(135deg, #10b981, #059669)',
              ...
              >
                ...
                >
                  Partner with e-commerce businesses for last-mile delivery and fulfillment.
                </p>
                <button
                  style={{
                    background: 'linear-gradient(135deg, #f59e0b, #d97706)',
