...
import { BrokerContractService } from '../../services/BrokerContractService';
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        >
          {[
            ...
            { id: 'ai-intelligence', label: '🤖 AI Intelligence', icon: Target },
            { id: 'contracts-bol', label: '📋 Contracts & BOL', icon: FileText },
      ...
      {activeTab === 'ai-intelligence' && (
        ...
        >
          <BrokerAIIntelligenceHub brokerId={session?.userId || 'ED-BB-2024061'} />
        </div>
      )}
