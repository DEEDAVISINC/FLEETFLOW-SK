          ...
          >
            ...
            <div>
              ...
              >
                ...
                >
                  Agent: {session?.firstName} {session?.lastName} | {currentAgent?.position}
                </div>
              </div>
            </div>
          </div>
      ...
      {activeTab === 'ai-intelligence' && (
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ color: '#10b981', fontSize: '18px', fontWeight: 'bold', marginBottom: '15px' }}>
                🎯 Smart Load Matching
              </h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px', marginBottom: '15px' }}>
                AI-powered load recommendations based on your customer patterns and performance history.
              </p>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ color: '#10b981', fontSize: '12px', fontWeight: '600' }}>STATUS: ACTIVE</span>
                <span style={{ color: 'white', fontSize: '16px', fontWeight: 'bold' }}>127 Matches</span>
              </div>
            </div>
            ...
            >
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px', marginBottom: '15px' }}>
                Dynamic pricing recommendations to maximize win rates and profitability.
              </p>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ color: '#3b82f6', fontSize: '12px', fontWeight: '600' }}>WIN RATE: 73%</span>
                <span style={{ color: 'white', fontSize: '16px', fontWeight: 'bold' }}>+12% Margin</span>
              </div>
            </div>
            ...
            >
              <h3 style={{ color: '#f59e0b', fontSize: '18px', fontWeight: 'bold', marginBottom: '15px' }}>
                ⚠️ Risk Assessment
              </h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px', marginBottom: '15px' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span style={{ color: '#f59e0b', fontSize: '12px', fontWeight: '600' }}>ALERTS: 3</span>
                <span style={{ color: 'white', fontSize: '16px', fontWeight: 'bold' }}>94% Safe</span>
              </div>
            </div>
          </div>
        </div>
          ...
          >
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  { company: 'ABC Manufacturing', stage: 'Negotiation', value: '$15,000', probability: '85%' },
                  { company: 'XYZ Logistics', stage: 'Proposal', value: '$8,500', probability: '60%' },
                  { company: 'Global Distributors', stage: 'Qualified', value: '$22,000', probability: '40%' },
                ].map((deal, index) => (
                  <div
                    key={index}
                    style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                <div style={{ textAlign: 'center', padding: '15px', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '8px' }}>
                  <div style={{ color: '#10b981', fontSize: '24px', fontWeight: 'bold' }}>34</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '12px' }}>Active Leads</div>
                </div>
                <div style={{ textAlign: 'center', padding: '15px', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '8px' }}>
                  <div style={{ color: '#3b82f6', fontSize: '24px', fontWeight: 'bold' }}>28%</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '12px' }}>Close Rate</div>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  { name: 'Swift Transportation', rating: '4.8', loads: '45', performance: '96%' },
                  { name: 'Werner Enterprises', rating: '4.6', loads: '32', performance: '94%' },
                  { name: 'J.B. Hunt', rating: '4.7', loads: '28', performance: '95%' },
                ].map((carrier, index) => (
                  <div
                    key={index}
                    style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                <div style={{ textAlign: 'center', padding: '15px', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '8px' }}>
                  <div style={{ color: '#0ea5e9', fontSize: '24px', fontWeight: 'bold' }}>78</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '12px' }}>Active Carriers</div>
                </div>
                <div style={{ textAlign: 'center', padding: '15px', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '8px' }}>
                  <div style={{ color: '#10b981', fontSize: '24px', fontWeight: 'bold' }}>4.6</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '12px' }}>Avg Rating</div>
                </div>
              </div>
            </div>
          </div>
      ...
      {activeTab === 'market-intelligence' && (
        ...
        >
          ...
          >
            ...
            >
              <h3 style={{ color: '#ec4899', fontSize: '18px', fontWeight: 'bold', marginBottom: '15px' }}>
                📈 Rate Trends
              </h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px' }}>ATL-MIA</span>
                  <span style={{ color: '#10b981', fontSize: '14px', fontWeight: '600' }}>+5.2%</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px' }}>JAX-TPA</span>
                  <span style={{ color: '#ef4444', fontSize: '14px', fontWeight: '600' }}>-2.1%</span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px' }}>ORL-SAV</span>
                  <span style={{ color: '#10b981', fontSize: '14px', fontWeight: '600' }}>+3.7%</span>
                </div>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div style={{ textAlign: 'center' }}>
                <div style={{ color: '#3b82f6', fontSize: '28px', fontWeight: 'bold' }}>$3.42</div>
                <div style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px' }}>Avg Diesel (FL)</div>
                <div style={{ color: '#f59e0b', fontSize: '12px', fontWeight: '600', marginTop: '5px' }}>+$0.08 vs last week</div>
              </div>
            </div>
            <div
              style={{
            ...
            >
              ...
              <div style={{ textAlign: 'center' }}>
                <div style={{ color: '#10b981', fontSize: '28px', fontWeight: 'bold' }}>78%</div>
                <div style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '14px' }}>Utilization</div>
                <div style={{ color: '#ec4899', fontSize: '12px', fontWeight: '600', marginTop: '5px' }}>TIGHT MARKET</div>
              </div>
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {[
                  { company: 'Regional Food Distributor', industry: 'Food & Beverage', size: 'Mid-Market', status: 'Cold Outreach' },
                  { company: 'Southeast Auto Parts', industry: 'Automotive', size: 'Enterprise', status: 'First Contact' },
                  { company: 'Coastal Furniture Co', industry: 'Furniture', size: 'SMB', status: 'Proposal Sent' },
                ].map((prospect, index) => (
                  <div
                    key={index}
                    style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                <div style={{ textAlign: 'center', padding: '15px', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '8px' }}>
                  <div style={{ color: '#a855f7', fontSize: '24px', fontWeight: 'bold' }}>23</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '12px' }}>Active Prospects</div>
                </div>
                <div style={{ textAlign: 'center', padding: '15px', background: 'rgba(255, 255, 255, 0.05)', borderRadius: '8px' }}>
                  <div style={{ color: '#10b981', fontSize: '24px', fontWeight: 'bold' }}>18%</div>
                  <div style={{ color: 'rgba(255, 255, 255, 0.8)', fontSize: '12px' }}>Conversion Rate</div>
                </div>
              </div>
            </div>
          </div>
