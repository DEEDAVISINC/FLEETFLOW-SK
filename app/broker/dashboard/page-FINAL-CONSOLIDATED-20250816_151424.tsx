        ...
        >
          ...
          <div style={{ display: 'flex', gap: '8px', marginBottom: '32px' }}>
            {[
              ...
              }, // FINANCIAL & COMPLIANCE - Green
              {
                id: 'network-automation',
                label: 'Network & Automation',
                icon: '🚛',
                color: 'linear-gradient(135deg, #f59e0b, #d97706)',
              }, // NETWORK & AUTOMATION - Amber
            ].map((tab) => (
              <button
                key={tab.id}
          ...
          >
            ...
            {selectedTab === 'business-intelligence' && (
              <div>
                <div
                  style={{
                    display: 'flex',
            ...
            {selectedTab === 'financial-compliance' && (
              <div>
                <h2
                  style={{
                    color: 'white',
            ...
            {selectedTab === 'network-automation' && (
              <div>
            ...
            {selectedTab === 'business-development' && (
              <div>
                <h2
                  style={{
                    color: 'white',
