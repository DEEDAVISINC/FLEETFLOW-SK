                    ...
                    {[
                      {
                        ...
                        activity: 'Requested new quote for Atlanta → Miami route',
                        value: '$4,200',
                        status: 'Quote Sent',
                        time: '2 hours ago',
                        priority: 'High'
                      },
                      {
                        ...
                        activity: 'Approved contract for Q1 2024 freight services',
                        value: '$85,000',
                      ...
                      },
                      {
                        ...
                        activity: 'Scheduled pickup for Chicago → Dallas shipment',
                        value: '$3,800',
                        status: 'Scheduled',
                        time: '6 hours ago',
                        priority: 'Medium'
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                          <div
                            style={{
                              ...
                              height: '12px',
                              borderRadius: '50%',
                              background: activity.priority === 'High' ? '#ef4444' : activity.priority === 'Medium' ? '#f59e0b' : '#10b981',
                            }}
                          />
                          <div>
