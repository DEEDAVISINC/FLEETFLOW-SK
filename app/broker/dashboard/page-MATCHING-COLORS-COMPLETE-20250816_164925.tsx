              ...
              >
                ...
                >
                  {[
                    ...
                    { id: 'Specialized', label: 'Specialized', icon: '⭐', color: '#6366f1' },
                    { id: 'Warehousing', label: 'Warehousing', icon: '🏢', color: '#14b8a6' },
                    { id: 'Multi-Service', label: 'Multi-Service', icon: '🔄', color: '#f59e0b' },
                    { id: 'SpotRates', label: 'Spot Rates', icon: '📈', color: '#10b981' },
                      ...
                      style={{
                        ...
                        backgroundColor:
                          activeQuoteTab === tab.id
                            ? `${tab.color}20` // Use tab's color with transparency
                        ...
                        border:
                          activeQuoteTab === tab.id
                            ? `1px solid ${tab.color}40` // Use tab's color with transparency
