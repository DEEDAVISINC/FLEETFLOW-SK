    ...
    const mockNotifications: FleetNotification[] = [
      {
        ...
        message:
          'Driver breakdown reported on I-95. Immediate assistance required.',
      ...
      },
      {
        ...
        message:
          'Carrier MC-12345 insurance status expired. Immediate review required.',
      ...
      },
      {
        ...
        message:
          'Load LD-2025-123 delivered successfully with POD confirmation.',
      ...
      },
      {
        ...
        message:
          'Alex Rodriguez (Broker) requests immediate driver assignment for urgent customer delivery.',
      ...
      },
      {
        ...
        message:
          'Sarah Johnson (Dispatch) reports weather delay - need to notify customer immediately.',
      ...
      },
      {
        ...
        message:
          'IT Admin: System maintenance scheduled for tonight. Please complete urgent tasks.',
        timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
        read: false,
        ...
        >
          ...
          >
            {[
              ...
              {
                label: 'Live Critical',
                value: stats.liveAlerts.critical,
                color: '#dc2626',
                icon: '🚨',
              },
              {
                label: 'Live Warning',
                value: stats.liveAlerts.warning,
                color: '#f59e0b',
                icon: '⚠️',
              },
              {
                label: 'Live Info',
                value: stats.liveAlerts.info,
                color: '#3b82f6',
                icon: 'ℹ️',
              },
              {
                label: 'Total Live',
                value: stats.liveAlerts.total,
                color: '#8b5cf6',
                icon: '🔄',
              },
            ].map((stat, index) => (
        ...
        {activeTab === 'notifications' ? (
                            ...
                            >
                              ...
                              {notification.metadata.action && (
                                <span>
                                  ...
                                  {notification.metadata.action.replace(
                                    '_',
                                    ' '
                                  )}
                                </span>
          ...
          >
            ...
            >
              ...
              >
                Real-time alerts requiring immediate attention • Auto-refreshes
                every 30 seconds
              </p>
            </div>
