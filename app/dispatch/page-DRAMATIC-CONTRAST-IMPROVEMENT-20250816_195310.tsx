        ...
        >
          ...
          {selectedTab === 'dashboard' && (
            <div style={{
              ...
              <style jsx>{`
                .dispatch-invitation-override * {
                  color: #2d3748 !important;
                }
                .dispatch-invitation-override input {
                  background: rgba(0, 0, 0, 0.05) !important;
                  border: 1px solid #d1d5db !important;
                  color: #2d3748 !important;
                }
                .dispatch-invitation-override input::placeholder {
                  color: #6b7280 !important;
                }
                .dispatch-invitation-override button {
              ...
              <div style={{ 
                ...
                📧 Carrier Invitations - Quick Access
              </div>
              <div className="dispatch-invitation-override"">
