                ...
                {[
                  ...
                  >
                    ...
                    >
                     ...
                     {/* Carrier Invitation Management - Compact */}
           {selectedTab === 'dashboard' && (
             <div
               style={{
                 marginBottom: '15px',
             ...
             >
               <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                 <span style={{ fontWeight: '600', fontSize: '0.9rem' }}>📧 Carrier Invitations</span>
                 <div style={{ display: 'flex', gap: '8px', fontSize: '0.7rem' }}>
                   <span style={{ background: 'rgba(255,255,255,0.2)', padding: '2px 6px', borderRadius: '4px' }}>📧 8</span>
                   <span style={{ background: 'rgba(255,255,255,0.2)', padding: '2px 6px', borderRadius: '4px' }}>👁️ 5</span>
                   <span style={{ background: 'rgba(255,255,255,0.2)', padding: '2px 6px', borderRadius: '4px' }}>✅ 3</span>
                 </div>
               </div>
