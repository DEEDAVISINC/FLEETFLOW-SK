      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              display: 'grid',
              gridTemplateColumns: '80px 1.5fr 1fr 120px 100px 100px 100px 120px',
              gap: '10px',
              padding: '12px 15px',
              background: 'rgba(0, 0, 0, 0.6)',
              fontWeight: '700',
            ...
            {[
              { id: 'L-001', origin: 'Los Angeles, CA', destination: 'Phoenix, AZ', broker: 'Mike Johnson', rate: 2800, status: 'Available', distance: '372', type: 'Dry Van', dispatcher: 'Mike Johnson' },
              { id: 'L-002', origin: 'Chicago, IL', destination: 'Dallas, TX', broker: 'Sarah Wilson', rate: 3200, status: 'Assigned', distance: '925', type: 'Reefer', dispatcher: 'Sarah Wilson' },
              { id: 'L-003', origin: 'Miami, FL', destination: 'Atlanta, GA', broker: 'Tom Davis', rate: 1800, status: 'In Transit', distance: '661', type: 'Flatbed', dispatcher: 'Tom Davis' },
              { id: 'L-004', origin: 'Seattle, WA', destination: 'Portland, OR', broker: 'Lisa Chen', rate: 1200, status: 'Available', distance: '173', type: 'Dry Van', dispatcher: 'Lisa Chen' },
              { id: 'L-005', origin: 'Denver, CO', destination: 'Salt Lake City, UT', broker: 'James Brown', rate: 1500, status: 'Delivered', distance: '371', type: 'Reefer', dispatcher: 'James Brown' },
              { id: 'L-006', origin: 'Houston, TX', destination: 'New Orleans, LA', broker: 'Maria Garcia', rate: 2200, status: 'Available', distance: '348', type: 'Dry Van', dispatcher: 'Maria Garcia' },
              { id: 'L-007', origin: 'Detroit, MI', destination: 'Cleveland, OH', broker: 'David Miller', rate: 1600, status: 'Assigned', distance: '169', type: 'Flatbed', dispatcher: 'David Miller' },
              { id: 'L-008', origin: 'Boston, MA', destination: 'New York, NY', broker: 'Jennifer Lee', rate: 1400, status: 'In Transit', distance: '215', type: 'Dry Van', dispatcher: 'Jennifer Lee' }
            ].map((load, index) => (
