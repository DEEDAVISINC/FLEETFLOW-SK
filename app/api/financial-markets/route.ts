    ...
    if (fredApiKey) {
      ...
      if (response.ok) {
        ...
        if (observations && observations.length > 0) {
          ...
          const previousPrice = previousObs
  ...
  if (volatility > 0.05) {
    ...
    if (fuelPrice.priceChange > 0) {
      recommendation = {
        ...
        risk: 'HIGH',
        message:
          'Fuel prices rising rapidly. Consider buying futures contracts to lock in current rates.',
      ...
      recommendation = {
        ...
        risk: 'MODERATE',
        message:
          'Fuel prices falling. Monitor market conditions before hedging.',
        confidence: 75,
      };
    }
    ...
    recommendation = {
      ...
      risk: 'MODERATE',
      message:
        'Moderate price movement. Current hedging positions are adequate.',
      confidence: 70,
    };
  } else {
    // Low volatility
    recommendation = {
      ...
      risk: 'LOW',
      message:
        'Stable fuel prices. Continue monitoring for significant changes.',
      confidence: 80,
    };
  }
