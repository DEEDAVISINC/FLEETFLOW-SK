  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {getStatusIcon(carrier.onboardingStatus)}{' '}
          {carrier.onboardingStatus.replace('_', ' ')}
        </span>
      </div>
      ...
      >
        <div style={{ textAlign: 'center' }}>
          <div
            style={{
              color: carrier.documentsComplete ? '#10b981' : '#f59e0b',
              fontSize: '1.5rem',
            }}
          >
        ...
        <div style={{ textAlign: 'center' }}>
          <div
            style={{
              color: carrier.agreementsSigned ? '#10b981' : '#f59e0b',
              fontSize: '1.5rem',
            }}
          >
        ...
        <div style={{ textAlign: 'center' }}>
          <div
            style={{
              color: carrier.portalSetup ? '#10b981' : '#f59e0b',
              fontSize: '1.5rem',
            }}
          >
            {carrier.portalSetup ? '👤✅' : '👤⏳'}
...
export default function CarrierOnboardingPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    'dashboard' | 'carriers' | 'factoring' | 'documents'
  >('dashboard');
  const { user } = getCurrentUser();

  // Check access permission AFTER hooks
  ...
  const completedCarriers = carriers.filter(
    (c) => c.onboardingStatus === 'completed'
  ).length;
  const inProgressCarriers = carriers.filter(
    (c) => c.onboardingStatus === 'in_progress'
  ).length;
  const pendingCarriers = carriers.filter(
    (c) => c.onboardingStatus === 'pending'
  ).length;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Streamlined carrier verification, documentation, and onboarding
            workflow
          </p>
          <div
            style={{
          ...
          >
            ...
            <button
              onClick={() =>
                window.open('/university/carrier-onboard-workflow', '_blank')
              }
              style={{
        ...
        >
          {[
            ...
            >
              <div>{tab.label}</div>
              <div
                style={{ fontSize: '0.7rem', opacity: 0.8, marginTop: '2px' }}
              >
                {tab.desc}
              </div>
            </button>
              ...
              >
                ...
                >
                  <div>
                    ...
                    <p
                      style={{ fontSize: '12px', color: '#fbbf24', margin: 0 }}
                    >
                      Active onboarding
                    </p>
                  </div>
              ...
              >
                ...
                >
                  <div>
                    ...
                    <p
                      style={{ fontSize: '12px', color: '#f87171', margin: 0 }}
                    >
                      Awaiting start
                    </p>
                  </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div
                        style={{
                          background: carrier.documentsComplete
                            ? 'rgba(16, 185, 129, 0.2)'
                            : 'rgba(239, 68, 68, 0.2)',
                          padding: '8px 12px',
                          borderRadius: '8px',
                          color: carrier.documentsComplete
                            ? '#10b981'
                            : '#ef4444',
                          textAlign: 'center',
                      ...
                      <div
                        style={{
                          background: carrier.agreementsSigned
                            ? 'rgba(16, 185, 129, 0.2)'
                            : 'rgba(239, 68, 68, 0.2)',
                          padding: '8px 12px',
                          borderRadius: '8px',
                          color: carrier.agreementsSigned
                            ? '#10b981'
                            : '#ef4444',
                          textAlign: 'center',
                    ...
                    >
                      <button
                        ...
                        onClick={() =>
                          alert(`Viewing details for ${carrier.legalName}`)
                        }
                      >
                        View Details
                      </button>
              ...
              >
                {[
                  ...
                  <div
                    ...
                    onClick={() =>
                      alert(
                        `📂 Opening ${category.name} category with ${category.count} documents`
                      )
                    }
                  >
                    <div
