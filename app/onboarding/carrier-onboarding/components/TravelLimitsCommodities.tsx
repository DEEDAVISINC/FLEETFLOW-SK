  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '8px', marginBottom: '32px', borderBottom: '2px solid #e5e7eb' }}>
        <button onClick={() => setTab('travel')} style={{ padding: '12px 24px', borderRadius: '8px 8px 0 0', border: 'none', background: tab==='travel' ? '#1e40af' : 'transparent', color: tab==='travel' ? 'white' : '#6b7280', fontWeight: '600', cursor: 'pointer' }}>🗺️ Travel Limits</button>
        <button onClick={() => setTab('commodities')} style={{ padding: '12px 24px', borderRadius: '8px 8px 0 0', border: 'none', background: tab==='commodities' ? '#1e40af' : 'transparent', color: tab==='commodities' ? 'white' : '#6b7280', fontWeight: '600', cursor: 'pointer' }}>📦 Commodities</button>
        <button onClick={() => setTab('equipment')} style={{ padding: '12px 24px', borderRadius: '8px 8px 0 0', border: 'none', background: tab==='equipment' ? '#1e40af' : 'transparent', color: tab==='equipment' ? 'white' : '#6b7280', fontWeight: '600', cursor: 'pointer' }}>🚛 Equipment</button>
      </div>
      {tab==='travel' && (
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px', paddingTop: '24px', borderTop: '1px solid #e5e7eb' }}>
        <button onClick={onBack} style={{ background: '#6b7280', color: 'white', padding: '12px 24px', borderRadius: '8px', border: 'none', fontSize: '1rem', fontWeight: '600', cursor: 'pointer' }}>← Back</button>
        <button onClick={handleNext} style={{ background: '#1e40af', color: 'white', padding: '12px 24px', borderRadius: '8px', border: 'none', fontSize: '1rem', fontWeight: '600', cursor: 'pointer' }}>Next →</button>
      </div>
    </div>
  );
};