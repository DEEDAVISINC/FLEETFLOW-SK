...
export default function AIHubPage() {
  const [currentPage, setCurrentPage] = useState<'ai-flow' | 'ai-hub'>(('ai-hub'))
  ...
  return (
    <div style={{
      ...
      `,
      backgroundSize: '100% 100%, 100% 100%, 800px 800px, 600px 600px, 400px 400px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div style={{
                  ...
                  height: '12px',
                  borderRadius: '50%',
                  background: currentPage === 'ai-flow' ? '#ffffff' : 'rgba(255, 255, 255, 0.4)'
                }}></div>
                <span style={{
                  fontSize: '14px',
                  fontWeight: '600',
                  color: currentPage === 'ai-flow' ? '#ffffff' : 'rgba(255, 255, 255, 0.7)'
                }}>
                  AI Flow
                </span>
              </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div style={{
                  ...
                  height: '12px',
                  borderRadius: '50%',
                  background: currentPage === 'ai-hub' ? '#ffffff' : 'rgba(255, 255, 255, 0.4)'
                }}></div>
                <span style={{
                  fontSize: '14px',
                  fontWeight: '600',
                  color: currentPage === 'ai-hub' ? '#ffffff' : 'rgba(255, 255, 255, 0.7)'
                }}>
                  AI Hub
                </span>
              </div>
          ...
          <div>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Complete AI-powered freight operations with comprehensive automation and intelligence
              </p>
            </div>
