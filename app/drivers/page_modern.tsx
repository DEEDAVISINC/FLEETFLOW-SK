    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-purple-50/20">
      <div className="p-6 space-y-8">
        ...
        <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl shadow-2xl">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-6">
                ...
                <div className="text-white">
                  <h1 className="text-4xl font-bold mb-2">Driver Management</h1>
                  <p className="text-blue-100 text-lg">Manage your drivers and carrier partnerships</p>
                </div>
              </div>
              <button 
                onClick={() => setShowDriverModal(true)}
                className="bg-white/20 hover:bg-white/30 backdrop-blur-sm text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 border border-white/20 hover:border-white/40"
              >
                + Add Driver
              </button>
            </div>
          ...
          <div className="absolute bottom-0 left-0 -ml-8 -mb-8 w-24 h-24 bg-indigo-400/20 rounded-full blur-lg"></div>
        </div>
